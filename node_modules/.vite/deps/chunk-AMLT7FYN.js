...
var client_default = (element) => async (Component, props, { default: children, ...slotted }) => {
  ...
  if (signalsRaw) {
    const { signal } = await import("./signals.module-KF24MISL.js");
...
//# sourceMappingURL=chunk-AMLT7FYN.js.map
