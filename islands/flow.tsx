...
import {Component, Consumer, Producer, Service,} from "../components/customNodes.tsx";
import {
    MarkerType,
    useNodesState,
...
import "flowbite";
import {useCallback, useEffect, useState,} from "https://esm.sh/preact@10.15.1/hooks";
