...
class WASMRequest$Type extends MessageType<WASMRequest> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* protos.PipelineStep step */ 1:
          message.step = PipelineStep.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.step,
  ...
  internalBinaryWrite(
    ...
    if (message.step) {
      PipelineStep.internalBinaryWrite(
        message.step,
  ...
  constructor() {
    super("protos.WASMResponse", [
      { no: 1, name: "output", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
      {
        ...
        name: "exit_code",
        kind: "enum",
        T: () => ["protos.WASMExitCode", WASMExitCode],
      },
...
class PipelineStep$Type extends MessageType<PipelineStep> {
  constructor() {
    super("protos.PipelineStep", [
      ...
      { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
      {
        ...
        T: () => ["protos.PipelineStepCondition", PipelineStepCondition],
      },
      {
        no: 1000,
        name: "detective",
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* protos.steps.DetectiveStep detective */ 1000:
          message.step = {
            oneofKind: "detective",
            detective: DetectiveStep.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.step as any).detective,
            ),
          };
          break;
        case /* protos.steps.TransformStep transform */ 1001:
          message.step = {
            oneofKind: "transform",
            transform: TransformStep.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.step as any).transform,
            ),
          };
          break;
        case /* protos.steps.EncodeStep encode */ 1002:
          message.step = {
            oneofKind: "encode",
            encode: EncodeStep.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.step as any).encode,
            ),
          };
          break;
        case /* protos.steps.DecodeStep decode */ 1003:
          message.step = {
            oneofKind: "decode",
            decode: DecodeStep.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.step as any).decode,
            ),
          };
          break;
        case /* protos.steps.CustomStep custom */ 1004:
          message.step = {
            oneofKind: "custom",
            custom: CustomStep.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.step as any).custom,
            ),
          };
          break;
  ...
  internalBinaryWrite(
    ...
    if (message.step.oneofKind === "detective") {
      DetectiveStep.internalBinaryWrite(
        message.step.detective,
    ...
    if (message.step.oneofKind === "transform") {
      TransformStep.internalBinaryWrite(
        message.step.transform,
    ...
    if (message.step.oneofKind === "encode") {
      EncodeStep.internalBinaryWrite(
        message.step.encode,
        writer.tag(1002, WireType.LengthDelimited).fork(),
        options,
      ).join();
    }
    /* protos.steps.DecodeStep decode = 1003; */
    if (message.step.oneofKind === "decode") {
      DecodeStep.internalBinaryWrite(
        message.step.decode,
        writer.tag(1003, WireType.LengthDelimited).fork(),
        options,
      ).join();
    }
    /* protos.steps.CustomStep custom = 1004; */
    if (message.step.oneofKind === "custom") {
      CustomStep.internalBinaryWrite(
        message.step.custom,
        writer.tag(1004, WireType.LengthDelimited).fork(),
        options,
      ).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated protos.PipelineStep steps */ 3:
          message.steps.push(
            PipelineStep.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
...
class UnpausePipelineCommand$Type extends MessageType<UnpausePipelineCommand> {
  ...
  create(
    value?: PartialMessage<UnpausePipelineCommand>,
