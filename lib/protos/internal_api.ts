...
class HeartbeatRequest$Type extends MessageType<HeartbeatRequest> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* protos.Audience audience */ 1:
          message.audience = Audience.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.audience,
  ...
  internalBinaryWrite(
    ...
    if (message.lastActivityUnixTimestampUtc !== 0n) {
      writer.tag(2, WireType.Varint).int64(
        message.lastActivityUnixTimestampUtc,
      );
    }
...
class RegisterRequest$Type extends MessageType<RegisterRequest> {
  ...
  private binaryReadMap1000(
    map: RegisterRequest["Metadata"],
    reader: IBinaryReader,
    options: BinaryReadOptions,
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof RegisterRequest["Metadata"] | undefined,
      val: RegisterRequest["Metadata"][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field protos.RegisterRequest._metadata",
          );
      }
    }
    map[key ?? ""] = val ?? "";
  ...
  internalBinaryWrite(
    ...
    for (let k of Object.keys(message.Metadata)) {
      writer.tag(1000, WireType.LengthDelimited).fork().tag(
        1,
        WireType.LengthDelimited,
      ).string(k).tag(2, WireType.LengthDelimited).string(message.Metadata[k])
        .join();
    }
    let u = options.writeUnknownFields;
    if (u !== false) {
...
class CommandResponse$Type extends MessageType<CommandResponse> {
    ...
    super("protos.CommandResponse", [
      {
        ...
        name: "type",
        kind: "enum",
        T: () => ["protos.CommandType", CommandType],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* protos.SetPipelineCommand set_pipeline */ 100:
          message.command = {
            oneofKind: "setPipeline",
            setPipeline: SetPipelineCommand.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.command as any).setPipeline,
            ),
          };
          break;
        case /* protos.DeletePipelineCommand delete_pipeline */ 101:
          message.command = {
            oneofKind: "deletePipeline",
            deletePipeline: DeletePipelineCommand.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.command as any).deletePipeline,
            ),
          };
          break;
        case /* protos.PausePipelineCommand pause_pipeline */ 102:
          message.command = {
            oneofKind: "pausePipeline",
            pausePipeline: PausePipelineCommand.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.command as any).pausePipeline,
            ),
          };
          break;
        case /* protos.UnpausePipelineCommand unpause_pipeline */ 103:
          message.command = {
            oneofKind: "unpausePipeline",
            unpausePipeline: UnpausePipelineCommand.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.command as any).unpausePipeline,
            ),
          };
          break;
        case /* map<string, string> _metadata */ 1000:
  ...
  private binaryReadMap1000(
    map: CommandResponse["Metadata"],
    reader: IBinaryReader,
    options: BinaryReadOptions,
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof CommandResponse["Metadata"] | undefined,
      val: CommandResponse["Metadata"][any] | undefined;
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            "unknown map entry field for field protos.CommandResponse._metadata",
          );
      }
    }
    map[key ?? ""] = val ?? "";
  ...
  internalBinaryWrite(
    ...
    if (message.command.oneofKind === "setPipeline") {
      SetPipelineCommand.internalBinaryWrite(
        message.command.setPipeline,
    ...
    if (message.command.oneofKind === "deletePipeline") {
      DeletePipelineCommand.internalBinaryWrite(
        message.command.deletePipeline,
    ...
    if (message.command.oneofKind === "pausePipeline") {
      PausePipelineCommand.internalBinaryWrite(
        message.command.pausePipeline,
    ...
    if (message.command.oneofKind === "unpausePipeline") {
      UnpausePipelineCommand.internalBinaryWrite(
        message.command.unpausePipeline,
  ...
  constructor() {
    super("protos.Audience", [
      ...
      },
      {
        ...
        name: "operation_type",
        kind: "enum",
        T: () => ["protos.OperationType", OperationType, "OPERATION_TYPE_"],
      },
    ]);
  }
