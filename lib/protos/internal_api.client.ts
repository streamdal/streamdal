...
export interface IInternalClient {
  ...
  register(
    ...
    options?: RpcOptions,
  ): ServerStreamingCall<RegisterRequest, CommandResponse>;
  /**
  ...
  heartbeat(
    ...
    options?: RpcOptions,
  ): UnaryCall<HeartbeatRequest, StandardResponse>;
  /**
  ...
  notify(
    input: NotifyRequest,
    options?: RpcOptions,
  ): UnaryCall<NotifyRequest, StandardResponse>;
  /**
  ...
  metrics(
    ...
    options?: RpcOptions,
  ): UnaryCall<MetricsRequest, StandardResponse>;
}
/**
 * @generated from protobuf service protos.Internal
 */
export class InternalClient implements IInternalClient, ServiceInfo {
  ...
  register(
    ...
    return stackIntercept<RegisterRequest, CommandResponse>(
      "serverStreaming",
      this._transport,
      method,
      opt,
  ...
  heartbeat(
    ...
    return stackIntercept<HeartbeatRequest, StandardResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  notify(
    ...
    return stackIntercept<NotifyRequest, StandardResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  metrics(
    ...
    return stackIntercept<MetricsRequest, StandardResponse>(
      "unary",
      this._transport,
      method,
      opt,
