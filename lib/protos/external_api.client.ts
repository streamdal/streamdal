...
export interface IExternalClient {
  ...
  getServices(
    ...
    options?: RpcOptions,
  ): UnaryCall<GetServicesRequest, GetServicesResponse>;
  /**
   ...
   */
  getPipelines(
    input: GetPipelinesRequest,
    options?: RpcOptions,
  ): UnaryCall<GetPipelinesRequest, GetPipelinesResponse>;
  /**
  ...
  getPipeline(
    ...
    options?: RpcOptions,
  ): UnaryCall<GetPipelineRequest, GetPipelineResponse>;
  /**
   ...
   */
  setPipeline(
    input: SetPipelineRequest,
    options?: RpcOptions,
  ): UnaryCall<SetPipelineRequest, SetPipelineResponse>;
  /**
   * Delete a pipeline
   *
  ...
  deletePipeline(
    ...
    options?: RpcOptions,
  ): UnaryCall<DeletePipelineRequest, DeletePipelineResponse>;
  /**
   ...
   */
  getSteps(
    input: GetStepsRequest,
    options?: RpcOptions,
  ): UnaryCall<GetStepsRequest, GetStepsResponse>;
  /**
   * Create a step
   *
  ...
  createStep(
    ...
    options?: RpcOptions,
  ): UnaryCall<CreateStepRequest, CreateStepResponse>;
  /**
   * Update a step
   *
  ...
  updateStep(
    ...
    options?: RpcOptions,
  ): UnaryCall<UpdateStepRequest, UpdateStepResponse>;
  /**
   * Delete a step
   *
   ...
   */
  deleteStep(
    input: DeleteStepRequest,
    options?: RpcOptions,
  ): UnaryCall<DeleteStepRequest, DeleteStepResponse>;
  /**
   * Test method
   *
...
export class ExternalClient implements IExternalClient, ServiceInfo {
  ...
  getServices(
    ...
    return stackIntercept<GetServicesRequest, GetServicesResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  getPipelines(
    ...
    return stackIntercept<GetPipelinesRequest, GetPipelinesResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  getPipeline(
    ...
    return stackIntercept<GetPipelineRequest, GetPipelineResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  setPipeline(
    ...
    return stackIntercept<SetPipelineRequest, SetPipelineResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  deletePipeline(
    ...
    return stackIntercept<DeletePipelineRequest, DeletePipelineResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  getSteps(
    ...
    return stackIntercept<GetStepsRequest, GetStepsResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  createStep(
    ...
    return stackIntercept<CreateStepRequest, CreateStepResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  updateStep(
    ...
    return stackIntercept<UpdateStepRequest, UpdateStepResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  deleteStep(
    ...
    return stackIntercept<DeleteStepRequest, DeleteStepResponse>(
      "unary",
      this._transport,
      method,
      opt,
  ...
  test(
    ...
    return stackIntercept<TestRequest, TestResponse>(
      "unary",
      this._transport,
      method,
      opt,
