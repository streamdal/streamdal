...
class o {
  ...
  static _walk(e, n) {
    return "string" == typeof n
      ? e.addText(n)
      : n.children && (e.openNode(n),
        n.children.forEach((n) => this._walk(e, n)),
        e.closeNode(n)),
      e;
  }
  static _collapse(e) {
    "string" != typeof e && e.children &&
...
var C = Object.freeze({
  ...
  SHEBANG: (e = {}) => {
    const n = /^#![ ]*\//;
    return e.binary && (e.begin = b(n, /.*\b/, e.binary, /\b.*/)),
      a({
        scope: "meta",
        begin: n,
        end: /$/,
...
const P = {},
  ...
  q = (e, ...n) => {
    console.debug("WARN: " + e, ...n);
  },
  H = (e, n) => {
    P[`${e}/${n}`] ||
      (console.debug(`Deprecated as of ${e}. ${n}`), P[`${e}/${n}`] = !0);
  },
  G = Error();
...
function W(e) {
  ((e) => {
    e.scope && "object" == typeof e.scope && null !== e.scope &&
  ...
  return e.classNameAliases = a(e.classNameAliases || {}),
    function t(r, s) {
      ...
      [R, L, W, $].forEach((e) => e(r, s)),
        ...
        r.isCompiled = !0;
      let l = null;
      return "object" == typeof r.keywords && r.keywords.$pattern &&
        ...
        (r.begin || (r.begin = /\B|\b/),
          ...
          r.endsWithParent && s.terminatorEnd &&
          (o.terminatorEnd += (r.end ? "|" : "") + s.terminatorEnd)),
        r.illegal && (o.illegalRe = n(r.illegal)),
        r.contains || (r.contains = []),
        r.contains = [].concat(...r.contains.map((e) =>
          ((e) => (e.variants && !e.cachedVariants &&
            (e.cachedVariants = e.variants.map((n) =>
              a(e, {
                variants: null,
              }, n)
            )),
            e.cachedVariants ? e.cachedVariants : X(e)
              ? a(e, {
        ...
        o.matcher = ((e) => {
          const n = new i();
          return e.contains.forEach(
            (e) => n.addRule(e.begin, { rule: e, type: "begin" }),
          ),
...
const J = t,
  ...
  ne = (t) => {
    ...
    function f(e, t, i, r) {
      ...
      function b(e, n) {
        return e.scope && "string" == typeof e.scope &&
          S.openNode(w.classNameAliases[e.scope] || e.scope),
          e.beginScope && (e.beginScope._wrap
            ? (g(
              A,
      ...
      function N(a, r) {
        ...
        if (
          "begin" === y.type && "end" === r.type && y.index === r.index &&
          "" === o
        ) {
      ...
      Object.assign(t, {
        ...
        registerLanguage: (e, n) => {
          ...
          try {
            ...
            if (
              K("Language definition for '{}' could not be registered.".replace(
                "{}",
                e,
              )), !s
            ) throw n;
        ...
        addPlugin: (e) => {
          ((e) => {
            e["before:highlightBlock"] && !e["before:highlightElement"] &&
  ...
  const n = e.regex,
    ...
    a = {
      ...
      isTrulyOpeningTag: (e, n) => {
        ...
        ((i = r.match(/^\s*=/)) ||
          (i = r.match(/^\s+extends\s+/)) && 0 === i.index) && n.ignoreMatch();
      },
    },
    i = {
      $pattern: _e,
...
var Ke = Object.freeze({
  ...
  grmr_cpp: (e) => {
    const n = e.regex,
      ...
      a = "decltype\\(auto\\)",
      i = "[a-zA-Z_]\\w*::",
      r = "(?!struct)(" + a + "|" + n.optional(i) + "[a-zA-Z_]\\w*" +
        n.optional("<[^<>]+>") + ")",
      s = {
        className: "type",
        begin: "\\b[a-z\\d_]*_t\\b",
  ...
  grmr_less: (e) => {
    ...
    const g = s.concat({
      ...
      p = {
        className: "variable",
        variants: [{ begin: "@" + a + "\\s*:", relevance: 15 }, {
          begin: "@" + a,
        }],
    ...
    return {
      ...
      contains: [
        ...
        a,
        {
          ...
          variants: [{ begin: /<\?xml/, relevance: 10, contains: [o] }, {
            begin: /<\?[a-z][a-z0-9]+/,
          }],
        },
        {
    ...
    const n = { match: /\s+/, relevance: 0 },
      ...
      o = {
        variants: [{
          className: "keyword",
          match: m(
            ...Ae.filter((e) => "string" != typeof e).concat(Se).map(ke),
            ...Me,
          ),
        }],
      },
