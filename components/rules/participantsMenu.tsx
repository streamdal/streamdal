        ...
        <div className={"rounded bg-purple-50 ml-4"}>
            ...
            >
                ...
                >
                    ...
                    <a href={`/service/${encodeURIComponent(data.audience.serviceName)}/component/${
                        encodeURIComponent(data.audience.componentName)
                    }/${
                        data.audience.operationType === 1
                            ? "consumer"
                            : "producer"
                    }/op/${encodeURIComponent(data.audience.operationName)}/pipeline/${data.pipeline?.id}/pause`}>
