                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div class="border-b rounded-t dark:border-gray-600 flex justify-between">
                            <div class="flex items-start justify-between p-4">
                                {props.name.params.info === "consumer" ? <Consumer className={"mx-2"}/> :
                        ...
                        <div id="accordion-collapse" data-accordion="collapse">
                            <h2 id="collapse-heading-1">
                                <button type="button"
                                        ...
                                        data-accordion-target="#collapse-body-1" aria-expanded="false"
                                    ...
                                    <h3 class="text-gray-700 text-sm font-semibold ml-3">Rules</h3>
                            ...
                            <h2 id="collapse-heading-2">
                                <button type="button"
                                        ...
                                        data-accordion-target="#collapse-body-2" aria-expanded="true"
                                    ...
                                    <h3 class="text-gray-700 text-sm font-semibold ml-3">Trends</h3>
                            ...
                            <div id="collapse-body-2" class="hidden"
                                ...
                                <div class="p-5 border border-b-1 border-gray-200 dark:border-gray-700">
                                    <h3 class="text-4xl text-green-500 font-semibold dark:text-gray-400">200GB</h3>
                                    <p class="text-gray-500 text-xs dark:text-gray-400">Trend Name</p>
                                </div>
                                <div
                                    class="px-5 py-1 border-x-1 border-gray-200 dark:border-gray-700 flex justify-between">
                                    <p class="text-gray-800 text-xs dark:text-gray-400">Trend Name</p>
                                    <div class="flex w-2/5 justify-between">
                                        <p class="text-gray-600 font-semibold text-sm">200GB</p>
                                        <p class="text-green-500 text-sm dark:text-gray-400">+15%</p>
                                    </div>
                                </div>
                                <div
                                    class="px-5 py-1 border-x-1 border-gray-200 dark:border-gray-700 flex justify-between">
                            ...
                            <h2 id="collapse-heading-3">
                                <button type="button"
                                    ...
                                    <h3 class="text-gray-700 text-sm font-semibold ml-3">Notifications</h3>
