...
In simple words, it's a workflow for data.

Pipelines are logical checks and rules data must adhere to so it can continue 
to be processed by your applications, and subsequently sent "downstream" 
