...
<div style="justify-content: center; display: flex;">
  <div style="background: linear-gradient(250deg, #956CFF, #FFD260); border-radius: 17px; padding: 2px; @media ">
    <div style="background-color: var(--color-purple-1000); display: inline-flex; padding: 20px; font-size: 22px; border-radius: 15px;">
      Ready to get started? Take a look at the [Quickstart Guide ⮕](/en/getting-started/quickstart/)
    </div>
  </div>
</div>