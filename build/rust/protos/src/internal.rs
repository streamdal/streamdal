...
pub struct GetAttachCommandsByServiceResponse {
    ...
    pub active: ::std::vec::Vec<super::command::Command>,
    // @@protoc_insertion_point(field:protos.GetAttachCommandsByServiceResponse.paused)
    pub paused: ::std::vec::Vec<super::command::Command>,
    // special fields
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    vice_name\x18\x01\x20\x01(\tR\x0bserviceName\"v\n\"GetAttachCommandsBySe\
    rviceResponse\x12'\n\x06active\x18\x01\x20\x03(\x0b2\x0f.protos.CommandR\
    \x06active\x12'\n\x06paused\x18\x02\x20\x03(\x0b2\x0f.protos.CommandR\
    \x06paused2\xb5\x03\n\x08Internal\x126\n\x08Register\x12\x17.protos.Regi\
    sterRequest\x1a\x0f.protos.Command0\x01\x12C\n\x0bNewAudience\x12\x1a.pr\
    otos.NewAudienceRequest\x1a\x18.protos.StandardResponse\x12?\n\tHeartbea\
    t\x12\x18.protos.HeartbeatRequest\x1a\x18.protos.StandardResponse\x129\n\
    ...
    Response\x12s\n\x1aGetAttachCommandsByService\x12).protos.GetAttachComma\
    ndsByServiceRequest\x1a*.protos.GetAttachCommandsByServiceResponseB4Z2gi\
    thub.com/streamdal/snitch-protos/build/go/protosJ\xf5\x1c\n\x06\x12\x04\
