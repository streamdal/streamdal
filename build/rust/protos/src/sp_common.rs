...
impl ::protobuf::Message for TailResponse {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.timestamp_ns != 0 {
            my_size += ::protobuf::rt::int64_size(4, self.timestamp_ns);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.timestamp_ns != 0 {
            os.write_int64(4, self.timestamp_ns)?;
        }
        if !self.data.is_empty() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    elineId\x12!\n\x0ctimestamp_ns\x18\x04\x20\x01(\x03R\x0btimestampNs\x12\
    \x12\n\x04data\x18\x05\x20\x01(\x0cR\x04data\"<\n\x0bTailCommand\x12-\n\
    \x07request\x18\x01\x20\x01(\x0b2\x13.protos.TailRequestR\x07request*\
    ...
    \x18TAIL_RESPONSE_TYPE_ERROR\x10\x02B4Z2github.com/streamdal/snitch-prot\
    os/build/go/protosJ\xf8\x13\n\x06\x12\x04\0\0S\x01\n\x08\n\x01\x0c\x12\
    ...
    \x20\0-\x01\x1a0\x20Used\x20to\x20indicate\x20who\x20a\x20command\x20is\
    ...
    \x12\x04B\0O\x01\x1a\x90\x01\x20TailResponse\x20originates\x20in\x20the\
    \x20SDK\x20and\x20then\x20is\x20sent\x20to\x20snitch\x20servers\x20where\
    \n\x20it\x20is\x20forwarded\x20to\x20the\x20correct\x20frontend\x20strea\
    ming\x20gRPC\x20connection\n\n\n\n\x03\x04\x04\x01\x12\x03B\x08\x14\n\
    ...
    \x04\x04\x02\x01\x01\x12\x03E\x0b\x13\n\x0c\n\x05\x04\x04\x02\x01\x03\
    \x12\x03E\x16\x17\n\x0b\n\x04\x04\x04\x02\x02\x12\x03G\x02\x19\n\x0c\n\
    \x05\x04\x04\x02\x02\x05\x12\x03G\x02\x08\n\x0c\n\x05\x04\x04\x02\x02\
    \x01\x12\x03G\t\x14\n\x0c\n\x05\x04\x04\x02\x02\x03\x12\x03G\x17\x18\n'\
    \n\x04\x04\x04\x02\x03\x12\x03J\x02\x19\x1a\x1a\x20Timestamp\x20in\x20na\
    noseconds\n\n\x0c\n\x05\x04\x04\x02\x03\x05\x12\x03J\x02\x07\n\x0c\n\x05\
    \x04\x04\x02\x03\x01\x12\x03J\x08\x14\n\x0c\n\x05\x04\x04\x02\x03\x03\
    \x12\x03J\x17\x18\n\x8e\x01\n\x04\x04\x04\x02\x04\x12\x03N\x02\x11\x1a\
    \x80\x01\x20Payload\x20data.\x20For\x20errors,\x20this\x20will\x20be\x20\
    the\x20error\x20message\n\x20For\x20payloads,\x20this\x20will\x20be\x20J\
    SON\x20of\x20the\x20payload\x20data,\x20post\x20processing\n\n\x0c\n\x05\
    \x04\x04\x02\x04\x05\x12\x03N\x02\x07\n\x0c\n\x05\x04\x04\x02\x04\x01\
    \x12\x03N\x08\x0c\n\x0c\n\x05\x04\x04\x02\x04\x03\x12\x03N\x0f\x10\n\n\n\
    \x02\x04\x05\x12\x04Q\0S\x01\n\n\n\x03\x04\x05\x01\x12\x03Q\x08\x13\n\
    \x0b\n\x04\x04\x05\x02\0\x12\x03R\x02\x1a\n\x0c\n\x05\x04\x05\x02\0\x06\
    \x12\x03R\x02\r\n\x0c\n\x05\x04\x05\x02\0\x01\x12\x03R\x0e\x15\n\x0c\n\
    \x05\x04\x05\x02\0\x03\x12\x03R\x18\x19b\x06proto3\
";
