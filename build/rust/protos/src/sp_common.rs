...
impl ::protobuf::Message for TailResponse {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.original_data.is_empty() {
            my_size += ::protobuf::rt::bytes_size(6, &self.original_data);
        }
        if !self.new_data.is_empty() {
            my_size += ::protobuf::rt::bytes_size(7, &self.new_data);
        }
        for (k, v) in &self._metadata {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::string_size(1, &k);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.original_data.is_empty() {
            os.write_bytes(6, &self.original_data)?;
        }
        if !self.new_data.is_empty() {
            os.write_bytes(7, &self.new_data)?;
        }
        for (k, v) in &self._metadata {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::string_size(1, &k);
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12>\n\t_metadata\x18\x03\x20\x03(\x0b2!.protos.TailRequest.MetadataEnt\
    ryR\x08Metadata\x1a;\n\rMetadataEntry\x12\x10\n\x03key\x18\x01\x20\x01(\
    \tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01\"\
    \x8c\x03\n\x0cTailResponse\x12,\n\x04type\x18\x01\x20\x01(\x0e2\x18.prot\
    os.TailResponseTypeR\x04type\x12,\n\x08audience\x18\x02\x20\x01(\x0b2\
    \x10.protos.AudienceR\x08audience\x12\x1f\n\x0bpipeline_id\x18\x03\x20\
    \x01(\tR\npipelineId\x12\x1d\n\nsession_id\x18\x04\x20\x01(\tR\tsessionI\
    d\x12!\n\x0ctimestamp_ns\x18\x05\x20\x01(\x03R\x0btimestampNs\x12#\n\ror\
    iginal_data\x18\x06\x20\x01(\x0cR\x0coriginalData\x12\x19\n\x08new_data\
    ...
    \x01\n\x02\x04\x04\x12\x04D\0X\x01\x1a\x90\x01\x20TailResponse\x20origin\
    ...
    \x12\x03D\x08\x14\n\x0b\n\x04\x04\x04\x02\0\x12\x03E\x02\x1c\n\x0c\n\x05\
    \x04\x04\x02\0\x06\x12\x03E\x02\x12\n\x0c\n\x05\x04\x04\x02\0\x01\x12\
    \x03E\x13\x17\n\x0c\n\x05\x04\x04\x02\0\x03\x12\x03E\x1a\x1b\n\x0b\n\x04\
    \x04\x04\x02\x01\x12\x03G\x02\x18\n\x0c\n\x05\x04\x04\x02\x01\x06\x12\
    \x03G\x02\n\n\x0c\n\x05\x04\x04\x02\x01\x01\x12\x03G\x0b\x13\n\x0c\n\x05\
    \x04\x04\x02\x01\x03\x12\x03G\x16\x17\n\x0b\n\x04\x04\x04\x02\x02\x12\
    \x03I\x02\x19\n\x0c\n\x05\x04\x04\x02\x02\x05\x12\x03I\x02\x08\n\x0c\n\
    \x05\x04\x04\x02\x02\x01\x12\x03I\t\x14\n\x0c\n\x05\x04\x04\x02\x02\x03\
    \x12\x03I\x17\x18\n\x0b\n\x04\x04\x04\x02\x03\x12\x03K\x02\x18\n\x0c\n\
    \x05\x04\x04\x02\x03\x05\x12\x03K\x02\x08\n\x0c\n\x05\x04\x04\x02\x03\
    \x01\x12\x03K\t\x13\n\x0c\n\x05\x04\x04\x02\x03\x03\x12\x03K\x16\x17\n'\
    \n\x04\x04\x04\x02\x04\x12\x03N\x02\x19\x1a\x1a\x20Timestamp\x20in\x20na\
    noseconds\n\n\x0c\n\x05\x04\x04\x02\x04\x05\x12\x03N\x02\x07\n\x0c\n\x05\
    \x04\x04\x02\x04\x01\x12\x03N\x08\x14\n\x0c\n\x05\x04\x04\x02\x04\x03\
    \x12\x03N\x17\x18\n\x8e\x01\n\x04\x04\x04\x02\x05\x12\x03R\x02\x1a\x1a\
    ...
    \x04\x04\x02\x05\x05\x12\x03R\x02\x07\n\x0c\n\x05\x04\x04\x02\x05\x01\
    \x12\x03R\x08\x15\n\x0c\n\x05\x04\x04\x02\x05\x03\x12\x03R\x18\x19\nG\n\
    \x04\x04\x04\x02\x06\x12\x03U\x02\x15\x1a:\x20For\x20payloads,\x20this\
    \x20will\x20be\x20the\x20new\x20data,\x20post\x20processing\n\n\x0c\n\
    \x05\x04\x04\x02\x06\x05\x12\x03U\x02\x07\n\x0c\n\x05\x04\x04\x02\x06\
    \x01\x12\x03U\x08\x10\n\x0c\n\x05\x04\x04\x02\x06\x03\x12\x03U\x13\x14\n\
