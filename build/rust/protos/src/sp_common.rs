...
pub struct Metric {
    ...
    // @@protoc_insertion_point(field:protos.Metric.sample_options)
...
impl Metric {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, SampleOptions>(
            "sample_options",
            |m: &Metric| { &m.sample_options },
            |m: &mut Metric| { &mut m.sample_options },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ence\x12<\n\x0esample_options\x18\x05\x20\x01(\x0b2\x15.protos.SampleOpt\
    ionsR\rsampleOptions\x1a9\n\x0bLabelsEntry\x12\x10\n\x03key\x18\x01\x20\
    \x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\x028\
    \x01\"\xac\x02\n\x0bTailRequest\x12+\n\x04type\x18\x01\x20\x01(\x0e2\x17\
    .protos.TailRequestTypeR\x04type\x12\x0e\n\x02id\x18\x02\x20\x01(\tR\x02\
    id\x12,\n\x08audience\x18\x03\x20\x01(\x0b2\x10.protos.AudienceR\x08audi\
    ence\x12$\n\x0bpipeline_id\x18\x04\x20\x01(\tH\0R\npipelineId\x88\x01\
    \x01\x12?\n\t_metadata\x18\xe8\x07\x20\x03(\x0b2!.protos.TailRequest.Met\
    adataEntryR\x08Metadata\x1a;\n\rMetadataEntry\x12\x10\n\x03key\x18\x01\
    \x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\x02\
    8\x01B\x0e\n\x0c_pipeline_id\"\xe8\x03\n\x0cTailResponse\x12,\n\x04type\
    \x18\x01\x20\x01(\x0e2\x18.protos.TailResponseTypeR\x04type\x12&\n\x0fta\
    il_request_id\x18\x02\x20\x01(\tR\rtailRequestId\x12,\n\x08audience\x18\
    \x03\x20\x01(\x0b2\x10.protos.AudienceR\x08audience\x12\x1f\n\x0bpipelin\
    e_id\x18\x04\x20\x01(\tR\npipelineId\x12\x1d\n\nsession_id\x18\x05\x20\
    \x01(\tR\tsessionId\x12!\n\x0ctimestamp_ns\x18\x06\x20\x01(\x03R\x0btime\
    stampNs\x12#\n\roriginal_data\x18\x07\x20\x01(\x0cR\x0coriginalData\x12\
    \x19\n\x08new_data\x18\x08\x20\x01(\x0cR\x07newData\x12@\n\t_metadata\
    \x18\xe8\x07\x20\x03(\x0b2\".protos.TailResponse.MetadataEntryR\x08Metad\
    ata\x12#\n\n_keepalive\x18\xe9\x07\x20\x01(\x08H\0R\tKeepalive\x88\x01\
    \x01\x1a;\n\rMetadataEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\
    \x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01B\r\n\x0bX_kee\
    palive\"B\n\x0cAudienceRate\x12\x14\n\x05bytes\x18\x01\x20\x01(\x01R\x05\
    bytes\x12\x1c\n\tprocessed\x18\x02\x20\x01(\x01R\tprocessed\"\xbd\x01\n\
    \x06Schema\x12\x1f\n\x0bjson_schema\x18\x01\x20\x01(\x0cR\njsonSchema\
    \x12\x19\n\x08_version\x18d\x20\x01(\x05R\x07Version\x12:\n\t_metadata\
    \x18\xe8\x07\x20\x03(\x0b2\x1c.protos.Schema.MetadataEntryR\x08Metadata\
    \x1a;\n\rMetadataEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\
    \x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01\"h\n\rSampleOptio\
    ns\x12\x1f\n\x0bsample_rate\x18\x01\x20\x01(\rR\nsampleRate\x126\n\x17sa\
    mple_interval_seconds\x18\x02\x20\x01(\rR\x15sampleIntervalSeconds*\xc3\
    \x01\n\x0cResponseCode\x12\x17\n\x13RESPONSE_CODE_UNSET\x10\0\x12\x14\n\
    \x10RESPONSE_CODE_OK\x10\x01\x12\x1d\n\x19RESPONSE_CODE_BAD_REQUEST\x10\
    \x02\x12\x1b\n\x17RESPONSE_CODE_NOT_FOUND\x10\x03\x12'\n#RESPONSE_CODE_I\
    NTERNAL_SERVER_ERROR\x10\x04\x12\x1f\n\x1bRESPONSE_CODE_GENERIC_ERROR\
    \x10\x05*c\n\rOperationType\x12\x18\n\x14OPERATION_TYPE_UNSET\x10\0\x12\
    \x1b\n\x17OPERATION_TYPE_CONSUMER\x10\x01\x12\x1b\n\x17OPERATION_TYPE_PR\
    ODUCER\x10\x02*n\n\x10TailResponseType\x12\x1c\n\x18TAIL_RESPONSE_TYPE_U\
    NSET\x10\0\x12\x1e\n\x1aTAIL_RESPONSE_TYPE_PAYLOAD\x10\x01\x12\x1c\n\x18\
    TAIL_RESPONSE_TYPE_ERROR\x10\x02*\xa2\x01\n\x0fTailRequestType\x12\x1b\n\
    \x17TAIL_REQUEST_TYPE_UNSET\x10\0\x12\x1b\n\x17TAIL_REQUEST_TYPE_START\
    \x10\x01\x12\x1a\n\x16TAIL_REQUEST_TYPE_STOP\x10\x02\x12\x1b\n\x17TAIL_R\
    EQUEST_TYPE_PAUSE\x10\x03\x12\x1c\n\x18TAIL_REQUEST_TYPE_RESUME\x10\x04B\
    -Z+github.com/streamdal/protos/build/go/protosJ\xb2\x20\n\x06\x12\x04\0\
    \0{\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x02\0\
    \x0f\n\x08\n\x01\x08\x12\x03\x04\0B\n\t\n\x02\x08\x0b\x12\x03\x04\0B\n;\
    \n\x02\x04\0\x12\x04\x07\0\x0c\x01\x1a/\x20Common\x20response\x20message\
    \x20for\x20many\x20gRPC\x20methods\n\n\n\n\x03\x04\0\x01\x12\x03\x07\x08\
    \x18\n8\n\x04\x04\0\x02\0\x12\x03\t\x02\x10\x1a+\x20Co-relation\x20ID\
    \x20for\x20the\x20request\x20/\x20response\n\n\x0c\n\x05\x04\0\x02\0\x05\
    ...
    \x02\x05\0\x12\x04\x0f\0\x16\x01\x1a3\x20Common\x20status\x20codes\x20us\
    ed\x20in\x20gRPC\x20method\x20responses\n\n\n\n\x03\x05\0\x01\x12\x03\
    ...
    \x02\x03\x03\x12\x03;\x20!\nB\n\x04\x04\x03\x02\x04\x12\x03<\x02'\"5\x20\
    protolint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\
    \x03\x02\x04\x06\x12\x03<\x02\x15\n\x0c\n\x05\x04\x03\x02\x04\x01\x12\
    \x03<\x16\x1f\n\x0c\n\x05\x04\x03\x02\x04\x03\x12\x03<\"&\n\n\n\x02\x05\
    \x02\x12\x04?\0C\x01\n\n\n\x03\x05\x02\x01\x12\x03?\x05\x15\n\x0b\n\x04\
    \x05\x02\x02\0\x12\x03@\x02\x1f\n\x0c\n\x05\x05\x02\x02\0\x01\x12\x03@\
    \x02\x1a\n\x0c\n\x05\x05\x02\x02\0\x02\x12\x03@\x1d\x1e\n\x0b\n\x04\x05\
    \x02\x02\x01\x12\x03A\x02!\n\x0c\n\x05\x05\x02\x02\x01\x01\x12\x03A\x02\
    \x1c\n\x0c\n\x05\x05\x02\x02\x01\x02\x12\x03A\x1f\x20\n\x0b\n\x04\x05\
    \x02\x02\x02\x12\x03B\x02\x1f\n\x0c\n\x05\x05\x02\x02\x02\x01\x12\x03B\
    \x02\x1a\n\x0c\n\x05\x05\x02\x02\x02\x02\x12\x03B\x1d\x1e\n\n\n\x02\x05\
    \x03\x12\x04E\0K\x01\n\n\n\x03\x05\x03\x01\x12\x03E\x05\x14\n\x0b\n\x04\
    \x05\x03\x02\0\x12\x03F\x02\x1e\n\x0c\n\x05\x05\x03\x02\0\x01\x12\x03F\
    \x02\x19\n\x0c\n\x05\x05\x03\x02\0\x02\x12\x03F\x1c\x1d\n\x0b\n\x04\x05\
    \x03\x02\x01\x12\x03G\x02\x1e\n\x0c\n\x05\x05\x03\x02\x01\x01\x12\x03G\
    \x02\x19\n\x0c\n\x05\x05\x03\x02\x01\x02\x12\x03G\x1c\x1d\n\x0b\n\x04\
    \x05\x03\x02\x02\x12\x03H\x02\x1d\n\x0c\n\x05\x05\x03\x02\x02\x01\x12\
    \x03H\x02\x18\n\x0c\n\x05\x05\x03\x02\x02\x02\x12\x03H\x1b\x1c\n\x0b\n\
    ...
    \x01\n\x02\x04\x04\x12\x04O\0h\x01\x1a\x93\x01\x20TailResponse\x20origin\
    ...
    \x12\x03[\x02\x19\x1a\x1a\x20Timestamp\x20in\x20nanoseconds\n\n\x0c\n\
    \x05\x04\x04\x02\x05\x05\x12\x03[\x02\x07\n\x0c\n\x05\x04\x04\x02\x05\
    \x01\x12\x03[\x08\x14\n\x0c\n\x05\x04\x04\x02\x05\x03\x12\x03[\x17\x18\n\
    \x8e\x01\n\x04\x04\x04\x02\x06\x12\x03_\x02\x1a\x1a\x80\x01\x20Payload\
    ...
    \x12\x03b\x02\x15\x1a:\x20For\x20payloads,\x20this\x20will\x20be\x20the\
    ...
    \x03d\x02&\"5\x20protolint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\
    \n\n\x0c\n\x05\x04\x04\x02\x08\x06\x12\x03d\x02\x14\n\x0c\n\x05\x04\x04\
    \x02\x08\x01\x12\x03d\x15\x1e\n\x0c\n\x05\x04\x04\x02\x08\x03\x12\x03d!%\
    \n\x88\x01\n\x04\x04\x04\x02\t\x12\x03g\x02\"\x1aD\x20Set\x20by\x20serve\
    ...
    SE\n\n\x0c\n\x05\x04\x04\x02\t\x04\x12\x03g\x02\n\n\x0c\n\x05\x04\x04\
    \x02\t\x05\x12\x03g\x0b\x0f\n\x0c\n\x05\x04\x04\x02\t\x01\x12\x03g\x10\
    \x1a\n\x0c\n\x05\x04\x04\x02\t\x03\x12\x03g\x1d!\n\n\n\x02\x04\x05\x12\
    \x04j\0m\x01\n\n\n\x03\x04\x05\x01\x12\x03j\x08\x14\n\x0b\n\x04\x04\x05\
    \x02\0\x12\x03k\x02\x13\n\x0c\n\x05\x04\x05\x02\0\x05\x12\x03k\x02\x08\n\
    \x0c\n\x05\x04\x05\x02\0\x01\x12\x03k\t\x0e\n\x0c\n\x05\x04\x05\x02\0\
    ...
    \x0b\n\x04\x04\x06\x02\0\x12\x03p\x02\x18\n\x0c\n\x05\x04\x06\x02\0\x05\
    \x12\x03p\x02\x07\n\x0c\n\x05\x04\x06\x02\0\x01\x12\x03p\x08\x13\n\x0c\n\
    \x05\x04\x06\x02\0\x03\x12\x03p\x16\x17\nB\n\x04\x04\x06\x02\x01\x12\x03\
    r\x02\x17\"5\x20protolint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\
    \n\x0c\n\x05\x04\x06\x02\x01\x05\x12\x03r\x02\x07\n\x0c\n\x05\x04\x06\
    \x02\x01\x01\x12\x03r\x08\x10\n\x0c\n\x05\x04\x06\x02\x01\x03\x12\x03r\
    \x13\x16\nB\n\x04\x04\x06\x02\x02\x12\x03t\x02&\"5\x20protolint:disable:\
    ...
    \x04\x07\x02\0\x01\x12\x03x\t\x14\n\x0c\n\x05\x04\x07\x02\0\x03\x12\x03x\
    \x17\x18\n\x0b\n\x04\x04\x07\x02\x01\x12\x03z\x02%\n\x0c\n\x05\x04\x07\
    \x02\x01\x05\x12\x03z\x02\x08\n\x0c\n\x05\x04\x07\x02\x01\x01\x12\x03z\t\
    \x20\n\x0c\n\x05\x04\x07\x02\x01\x03\x12\x03z#$b\x06proto3\
";
