...
class BusEvent$Type extends runtime_5.MessageType {
            ...
            switch (fieldNo) {
                ...
                case /* protos.CreatePipelineRequest create_pipeline_request */ 102:
                    message.event = {
                        ...
                        createPipelineRequest: sp_external_8.CreatePipelineRequest.internalBinaryRead(reader, reader.uint32(), options, message.event.createPipelineRequest)
                    };
                    break;
                case /* protos.DeletePipelineRequest delete_pipeline_request */ 103:
                    message.event = {
                        oneofKind: "deletePipelineRequest",
                        deletePipelineRequest: sp_external_7.DeletePipelineRequest.internalBinaryRead(reader, reader.uint32(), options, message.event.deletePipelineRequest)
                    };
                    break;
                case /* protos.UpdatePipelineRequest update_pipeline_request */ 104:
                    message.event = {
                        oneofKind: "updatePipelineRequest",
                        updatePipelineRequest: sp_external_6.UpdatePipelineRequest.internalBinaryRead(reader, reader.uint32(), options, message.event.updatePipelineRequest)
                    };
                    break;
                case /* protos.AttachPipelineRequest attach_pipeline_request */ 105:
                    message.event = {
                        oneofKind: "attachPipelineRequest",
                        attachPipelineRequest: sp_external_5.AttachPipelineRequest.internalBinaryRead(reader, reader.uint32(), options, message.event.attachPipelineRequest)
                    };
                    break;
                case /* protos.DetachPipelineRequest detach_pipeline_request */ 106:
                    message.event = {
                        oneofKind: "detachPipelineRequest",
                        detachPipelineRequest: sp_external_4.DetachPipelineRequest.internalBinaryRead(reader, reader.uint32(), options, message.event.detachPipelineRequest)
                    };
                    break;
                case /* protos.PausePipelineRequest pause_pipeline_request */ 107:
                    message.event = {
                        oneofKind: "pausePipelineRequest",
                        pausePipelineRequest: sp_external_3.PausePipelineRequest.internalBinaryRead(reader, reader.uint32(), options, message.event.pausePipelineRequest)
                    };
                    break;
                case /* protos.ResumePipelineRequest resume_pipeline_request */ 108:
                    message.event = {
                        oneofKind: "resumePipelineRequest",
                        resumePipelineRequest: sp_external_2.ResumePipelineRequest.internalBinaryRead(reader, reader.uint32(), options, message.event.resumePipelineRequest)
                    };
                    break;
                ...
                case /* protos.DeleteAudienceRequest delete_audience_request */ 111:
                    message.event = {
                        ...
                        deleteAudienceRequest: sp_external_1.DeleteAudienceRequest.internalBinaryRead(reader, reader.uint32(), options, message.event.deleteAudienceRequest)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.event.oneofKind === "createPipelineRequest")
            sp_external_8.CreatePipelineRequest.internalBinaryWrite(message.event.createPipelineRequest, writer.tag(102, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* protos.DeletePipelineRequest delete_pipeline_request = 103; */
        if (message.event.oneofKind === "deletePipelineRequest")
            sp_external_7.DeletePipelineRequest.internalBinaryWrite(message.event.deletePipelineRequest, writer.tag(103, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* protos.UpdatePipelineRequest update_pipeline_request = 104; */
        if (message.event.oneofKind === "updatePipelineRequest")
            sp_external_6.UpdatePipelineRequest.internalBinaryWrite(message.event.updatePipelineRequest, writer.tag(104, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* protos.AttachPipelineRequest attach_pipeline_request = 105; */
        if (message.event.oneofKind === "attachPipelineRequest")
            sp_external_5.AttachPipelineRequest.internalBinaryWrite(message.event.attachPipelineRequest, writer.tag(105, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* protos.DetachPipelineRequest detach_pipeline_request = 106; */
        if (message.event.oneofKind === "detachPipelineRequest")
            sp_external_4.DetachPipelineRequest.internalBinaryWrite(message.event.detachPipelineRequest, writer.tag(106, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* protos.PausePipelineRequest pause_pipeline_request = 107; */
        if (message.event.oneofKind === "pausePipelineRequest")
            sp_external_3.PausePipelineRequest.internalBinaryWrite(message.event.pausePipelineRequest, writer.tag(107, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* protos.ResumePipelineRequest resume_pipeline_request = 108; */
        if (message.event.oneofKind === "resumePipelineRequest")
            sp_external_2.ResumePipelineRequest.internalBinaryWrite(message.event.resumePipelineRequest, writer.tag(108, runtime_1.WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.event.oneofKind === "deleteAudienceRequest")
            sp_external_1.DeleteAudienceRequest.internalBinaryWrite(message.event.deleteAudienceRequest, writer.tag(111, runtime_1.WireType.LengthDelimited).fork(), options).join();
