...
class GetAllResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetAllResponse", [
            ...
            { no: 4, name: "config", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "message", T: () => exports.GetAllResponseAudiences } },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case 1:
                    ...
                    break;
                case 2:
                    val = exports.GetAllResponseAudiences.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for field protos.GetAllResponse.config");
            }
        }
        map[key !== null && key !== void 0 ? key : ""] = val !== null && val !== void 0 ? val : exports.GetAllResponseAudiences.create();
    }
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.config)) {
            ...
            writer.tag(2, runtime_1.WireType.LengthDelimited).fork();
            exports.GetAllResponseAudiences.internalBinaryWrite(message.config[k], writer, options);
            writer.join().join();
        }
...
// @generated message type with reflection information, may provide speed optimized methods
class GetAllResponseAudiences$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetAllResponseAudiences", [
            { no: 1, name: "audiences", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => sp_common_7.Audience }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.audiences.length; i++)
            sp_common_7.Audience.internalBinaryWrite(message.audiences[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.GetAllResponseAudiences = new GetAllResponseAudiences$Type();
// @generated message type with reflection information, may provide speed optimized methods
