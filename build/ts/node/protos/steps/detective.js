...
var DetectiveStep$Type = /** @class */ (function (_super) {
    __extends(DetectiveStep$Type, _super);
    function DetectiveStep$Type() {
        return _super.call(this, "protos.steps.DetectiveStep", [
            ...
            { no: 4, name: "type", kind: "enum", T: function () { return ["protos.steps.DetectiveType", DetectiveType, "DETECTIVE_TYPE_"]; } }
        ]) || this;
    }
