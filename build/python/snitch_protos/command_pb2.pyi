...
class KVCommand(_message.Message):
    ...
    instructions: _containers.RepeatedCompositeFieldContainer[_kv_pb2.KVInstruction]
    overwrite: bool
    def __init__(self, instructions: _Optional[_Iterable[_Union[_kv_pb2.KVInstruction, _Mapping]]] = ..., overwrite: bool = ...) -> None: ...
