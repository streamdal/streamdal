...
class BusEvent(_message.Message):
    __slots__ = ["_metadata", "attach_pipeline_request", "create_pipeline_request", "delete_pipeline_request", "deregister_request", "detach_pipeline_request", "heartbeat_request", "pause_pipeline_request", "register_request", "resume_pipeline_request", "source", "update_pipeline_request"]
