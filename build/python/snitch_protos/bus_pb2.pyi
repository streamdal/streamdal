...
class BusEvent(_message.Message):
    __slots__ = ["_metadata", "command_response", "deregister_request", "heartbeat_request", "register_request", "source"]
    ...
    command_response: _command_pb2.Command
    ...
    source: str
    def __init__(self, source: _Optional[str] = ..., command_response: _Optional[_Union[_command_pb2.Command, _Mapping]] = ..., register_request: _Optional[_Union[_internal_pb2.RegisterRequest, _Mapping]] = ..., deregister_request: _Optional[_Union[_internal_pb2.DeregisterRequest, _Mapping]] = ..., heartbeat_request: _Optional[_Union[_internal_pb2.HeartbeatRequest, _Mapping]] = ..., _metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
