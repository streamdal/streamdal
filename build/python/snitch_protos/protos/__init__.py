...
# sources: sp_bus.proto, sp_command.proto, sp_common.proto, sp_external.proto, sp_info.proto, sp_internal.proto, sp_kv.proto, sp_notify.proto, sp_pipeline.proto, sp_uibff.proto, sp_wsm.proto
...
class RegistrationStatusStatus(betterproto.Enum):
    STATUS_UNSET = 0
    STATUS_SUBMIT = 1
...
@dataclass(eq=False, repr=False)
class Verify(betterproto.Message):
    email: str = betterproto.string_field(1)
