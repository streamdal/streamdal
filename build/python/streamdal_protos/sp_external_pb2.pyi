...
class GetAllResponse(_message.Message):
    ...
    class ConfigEntry(_message.Message):
        ...
        key: str
        value: GetAllResponseAudiences
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[GetAllResponseAudiences, _Mapping]] = ...) -> None: ...
    ...
    config: _containers.MessageMap[str, GetAllResponseAudiences]
    ...
    def __init__(self, live: _Optional[_Iterable[_Union[_sp_info_pb2.LiveInfo, _Mapping]]] = ..., audiences: _Optional[_Iterable[_Union[_sp_common_pb2.Audience, _Mapping]]] = ..., pipelines: _Optional[_Mapping[str, _sp_info_pb2.PipelineInfo]] = ..., config: _Optional[_Mapping[str, GetAllResponseAudiences]] = ..., generated_at_unix_ts_ns_utc: _Optional[int] = ..., _keepalive: bool = ...) -> None: ...

class GetAllResponseAudiences(_message.Message):
    __slots__ = ["audiences"]
    AUDIENCES_FIELD_NUMBER: _ClassVar[int]
    audiences: _containers.RepeatedCompositeFieldContainer[_sp_common_pb2.Audience]
