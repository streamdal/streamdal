...
type BusEvent_HeartbeatRequest struct {
	HeartbeatRequest *HeartbeatRequest `protobuf:"bytes,102,opt,name=heartbeat_request,json=heartbeatRequest,proto3,oneof"`
}

type BusEvent_CreatePipelineRequest struct {
	CreatePipelineRequest *CreatePipelineRequest `protobuf:"bytes,103,opt,name=create_pipeline_request,json=createPipelineRequest,proto3,oneof"`
}

type BusEvent_DeletePipelineRequest struct {
	DeletePipelineRequest *DeletePipelineRequest `protobuf:"bytes,104,opt,name=delete_pipeline_request,json=deletePipelineRequest,proto3,oneof"`
}

type BusEvent_UpdatePipelineRequest struct {
	UpdatePipelineRequest *UpdatePipelineRequest `protobuf:"bytes,105,opt,name=update_pipeline_request,json=updatePipelineRequest,proto3,oneof"`
}

type BusEvent_AttachPipelineRequest struct {
	AttachPipelineRequest *AttachPipelineRequest `protobuf:"bytes,106,opt,name=attach_pipeline_request,json=attachPipelineRequest,proto3,oneof"`
}

type BusEvent_DetachPipelineRequest struct {
	DetachPipelineRequest *DetachPipelineRequest `protobuf:"bytes,107,opt,name=detach_pipeline_request,json=detachPipelineRequest,proto3,oneof"`
}

type BusEvent_PausePipelineRequest struct {
	PausePipelineRequest *PausePipelineRequest `protobuf:"bytes,108,opt,name=pause_pipeline_request,json=pausePipelineRequest,proto3,oneof"`
}

type BusEvent_ResumePipelineRequest struct {
	ResumePipelineRequest *ResumePipelineRequest `protobuf:"bytes,109,opt,name=resume_pipeline_request,json=resumePipelineRequest,proto3,oneof"`
}
...
var file_bus_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xed, 0x07, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x47, 0x0a, 0x11, 0x68, 0x65,
	0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18,
	0x66, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x48,
	...
	0x65, 0x73, 0x74, 0x12, 0x57, 0x0a, 0x17, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x70, 0x69,
	0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x67,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x15, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x69, 0x70,
	0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x57, 0x0a, 0x17,
	0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x5f,
	...
	0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x57, 0x0a, 0x17, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x15, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50,
	0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x57,
	0x0a, 0x17, 0x61, 0x74, 0x74, 0x61, 0x63, 0x68, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e,
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_bus_proto_goTypes = []interface{}{
	...
	(*HeartbeatRequest)(nil),      // 4: protos.HeartbeatRequest
	(*CreatePipelineRequest)(nil), // 5: protos.CreatePipelineRequest
	(*DeletePipelineRequest)(nil), // 6: protos.DeletePipelineRequest
	(*UpdatePipelineRequest)(nil), // 7: protos.UpdatePipelineRequest
	(*AttachPipelineRequest)(nil), // 8: protos.AttachPipelineRequest
	(*DetachPipelineRequest)(nil), // 9: protos.DetachPipelineRequest
	(*PausePipelineRequest)(nil),  // 10: protos.PausePipelineRequest
	(*ResumePipelineRequest)(nil), // 11: protos.ResumePipelineRequest
}
var file_bus_proto_depIdxs = []int32{
	...
	4,  // 2: protos.BusEvent.heartbeat_request:type_name -> protos.HeartbeatRequest
	5,  // 3: protos.BusEvent.create_pipeline_request:type_name -> protos.CreatePipelineRequest
	6,  // 4: protos.BusEvent.delete_pipeline_request:type_name -> protos.DeletePipelineRequest
	7,  // 5: protos.BusEvent.update_pipeline_request:type_name -> protos.UpdatePipelineRequest
	8,  // 6: protos.BusEvent.attach_pipeline_request:type_name -> protos.AttachPipelineRequest
	9,  // 7: protos.BusEvent.detach_pipeline_request:type_name -> protos.DetachPipelineRequest
	10, // 8: protos.BusEvent.pause_pipeline_request:type_name -> protos.PausePipelineRequest
	11, // 9: protos.BusEvent.resume_pipeline_request:type_name -> protos.ResumePipelineRequest
	1,  // 10: protos.BusEvent._metadata:type_name -> protos.BusEvent.MetadataEntry
