...
type KVResponse struct {
	...
	//
	//	*KVResponse_KvExistsResponse
	Response isKVResponse_Response `protobuf_oneof:"response"`
}

func (x *KVResponse) Reset() {
	*x = KVResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_steps_sp_steps_kv_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KVResponse) Descriptor() ([]byte, []int) {
	return file_steps_sp_steps_kv_proto_rawDescGZIP(), []int{3}
}

func (m *KVResponse) GetResponse() isKVResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *KVResponse) GetKvExistsResponse() *KVExistsResponse {
	if x, ok := x.GetResponse().(*KVResponse_KvExistsResponse); ok {
		return x.KvExistsResponse
	}
	return nil
}

type isKVResponse_Response interface {
	isKVResponse_Response()
}

type KVResponse_KvExistsResponse struct {
	KvExistsResponse *KVExistsResponse `protobuf:"bytes,1,opt,name=kv_exists_response,json=kvExistsResponse,proto3,oneof"`
}

func (*KVResponse_KvExistsResponse) isKVResponse_Response() {}
...
var file_steps_sp_steps_kv_proto_rawDesc = []byte{
	...
	,
...
var file_steps_sp_steps_kv_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_steps_sp_steps_kv_proto_goTypes = []interface{}{
	...
	(*KVResponse)(nil),       // 4: protos.steps.KVResponse
}
var file_steps_sp_steps_kv_proto_depIdxs = []int32{
	...
	2, // 2: protos.steps.KVResponse.kv_exists_response:type_name -> protos.steps.KVExistsResponse
...
func file_steps_sp_steps_kv_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_steps_sp_steps_kv_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_steps_sp_steps_kv_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*KVResponse_KvExistsResponse)(nil),
	}
	type x struct{}
