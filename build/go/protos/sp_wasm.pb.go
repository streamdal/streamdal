...
func (WASMExitCode) Descriptor() protoreflect.EnumDescriptor {
	return file_sp_wasm_proto_enumTypes[0].Descriptor()
}

func (WASMExitCode) Type() protoreflect.EnumType {
	return &file_sp_wasm_proto_enumTypes[0]
}
...
func (WASMExitCode) EnumDescriptor() ([]byte, []int) {
	return file_sp_wasm_proto_rawDescGZIP(), []int{0}
}
...
func (x *WASMRequest) Reset() {
	*x = WASMRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sp_wasm_proto_msgTypes[0]
...
func (x *WASMResponse) Reset() {
	*x = WASMResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sp_wasm_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WASMResponse) Descriptor() ([]byte, []int) {
	return file_sp_wasm_proto_rawDescGZIP(), []int{1}
}
...
var File_sp_wasm_proto protoreflect.FileDescriptor

var file_sp_wasm_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x73, 0x70, 0x5f, 0x77, 0x61, 0x73, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x1a, 0x11, 0x73, 0x70, 0x5f, 0x70, 0x69, 0x70, 0x65,
	0x6c, 0x69, 0x6e, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4d, 0x0a, 0x0b, 0x57, 0x41,
	...
	0x74, 0x65, 0x70, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x22, 0x74, 0x0a, 0x0c, 0x57, 0x41, 0x53,
	0x4d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x75, 0x74,
	0x70, 0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75,
	0x74, 0x12, 0x31, 0x0a, 0x09, 0x65, 0x78, 0x69, 0x74, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x02,
	...
	,
...
var (
	file_sp_wasm_proto_rawDescOnce sync.Once
	file_sp_wasm_proto_rawDescData = file_sp_wasm_proto_rawDesc
)

func file_sp_wasm_proto_rawDescGZIP() []byte {
	file_sp_wasm_proto_rawDescOnce.Do(func() {
		file_sp_wasm_proto_rawDescData = protoimpl.X.CompressGZIP(file_sp_wasm_proto_rawDescData)
	})
	return file_sp_wasm_proto_rawDescData
}

var file_sp_wasm_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_sp_wasm_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_sp_wasm_proto_goTypes = []interface{}{
...
var file_sp_wasm_proto_depIdxs = []int32{
...
func init() { file_sp_wasm_proto_init() }
func file_sp_wasm_proto_init() {
	if File_sp_wasm_proto != nil {
		return
	}
	file_sp_pipeline_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_sp_wasm_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sp_wasm_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sp_wasm_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sp_wasm_proto_goTypes,
		DependencyIndexes: file_sp_wasm_proto_depIdxs,
		EnumInfos:         file_sp_wasm_proto_enumTypes,
		MessageInfos:      file_sp_wasm_proto_msgTypes,
	}.Build()
	File_sp_wasm_proto = out.File
	file_sp_wasm_proto_rawDesc = nil
	file_sp_wasm_proto_goTypes = nil
	file_sp_wasm_proto_depIdxs = nil
}
