...
type BusEvent_TailRequest struct {
	TailRequest *TailRequest `protobuf:"bytes,112,opt,name=tail_request,json=tailRequest,proto3,oneof"`
}
...
var file_sp_bus_proto_rawDesc = []byte{
	...
	0x70, 0x5f, 0x6b, 0x76, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xae, 0x09, 0x0a, 0x08, 0x42,
	...
	0x0c, 0x74, 0x61, 0x69, 0x6c, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x70, 0x20,
...
var file_sp_bus_proto_goTypes = []interface{}{
	...
	(*TailRequest)(nil),           // 14: protos.TailRequest
}
var file_sp_bus_proto_depIdxs = []int32{
	...
	14, // 12: protos.BusEvent.tail_request:type_name -> protos.TailRequest
