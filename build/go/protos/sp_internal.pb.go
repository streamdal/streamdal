...
var file_sp_internal_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x52, 0x06, 0x70, 0x61, 0x75, 0x73, 0x65, 0x64, 0x32, 0xf3,
	0x03, 0x0a, 0x08, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x12, 0x36, 0x0a, 0x08, 0x52,
	...
	0x73, 0x65, 0x28, 0x01, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_sp_internal_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_sp_internal_proto_goTypes = []interface{}{
	...
	(*Metric)(nil),                             // 9: protos.Metric
	(*ClientInfo)(nil),                         // 10: protos.ClientInfo
	(*Command)(nil),                            // 11: protos.Command
	(*TailResponse)(nil),                       // 12: protos.TailResponse
...
var file_sp_internal_proto_depIdxs = []int32{
	...
	9,  // 2: protos.MetricsRequest.metrics:type_name -> protos.Metric
	10, // 3: protos.RegisterRequest.client_info:type_name -> protos.ClientInfo
	8,  // 4: protos.RegisterRequest.audiences:type_name -> protos.Audience
	11, // 5: protos.GetAttachCommandsByServiceResponse.active:type_name -> protos.Command
	11, // 6: protos.GetAttachCommandsByServiceResponse.paused:type_name -> protos.Command
	4,  // 7: protos.Internal.Register:input_type -> protos.RegisterRequest
	...
	3,  // 11: protos.Internal.Metrics:input_type -> protos.MetricsRequest
	6,  // 12: protos.Internal.GetAttachCommandsByService:input_type -> protos.GetAttachCommandsByServiceRequest
	12, // 13: protos.Internal.SendTail:input_type -> protos.TailResponse
	11, // 14: protos.Internal.Register:output_type -> protos.Command
	...
	7,  // 19: protos.Internal.GetAttachCommandsByService:output_type -> protos.GetAttachCommandsByServiceResponse
	13, // 20: protos.Internal.SendTail:output_type -> protos.StandardResponse
