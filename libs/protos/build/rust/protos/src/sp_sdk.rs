...
pub enum ExecStatus {
    ...
    EXEC_STATUS_ERROR = 3,
    // @@protoc_insertion_point(enum_value:protos.ExecStatus.EXEC_STATUS_ASYNC)
    EXEC_STATUS_ASYNC = 4,
    // @@protoc_insertion_point(enum_value:protos.ExecStatus.EXEC_STATUS_SAMPLING)
...
impl ::protobuf::Enum for ExecStatus {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ExecStatus> {
        match value {
            ...
            4 => ::std::option::Option::Some(ExecStatus::EXEC_STATUS_ASYNC),
            5 => ::std::option::Option::Some(ExecStatus::EXEC_STATUS_SAMPLING),
    ...
    fn from_str(str: &str) -> ::std::option::Option<ExecStatus> {
        match str {
            ...
            "EXEC_STATUS_ASYNC" => ::std::option::Option::Some(ExecStatus::EXEC_STATUS_ASYNC),
            "EXEC_STATUS_SAMPLING" => ::std::option::Option::Some(ExecStatus::EXEC_STATUS_SAMPLING),
            _ => ::std::option::Option::None
        }
    }
    ...
    const VALUES: &'static [ExecStatus] = &[
        ...
        ExecStatus::EXEC_STATUS_ASYNC,
        ExecStatus::EXEC_STATUS_SAMPLING,
    ];
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x15\n\x11EXEC_STATUS_ERROR\x10\x03\x12\x15\n\x11EXEC_STATUS_ASYNC\x10\
    \x04\x12\x18\n\x14EXEC_STATUS_SAMPLING\x10\x05*D\n\x07SDKMode\x12\x12\n\
    \x0eSDK_MODE_UNSET\x10\0\x12\x11\n\rSDK_MODE_SYNC\x10\x01\x12\x12\n\x0eS\
    DK_MODE_ASYNC\x10\x02BPZ:github.com/streamdal/streamdal/libs/protos/buil\
    d/go/protos\xea\x02\x11Streamdal::ProtosJ\x8c\x1f\n\x06\x12\x04\0\0o\x01\
    \n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x02\0\x0f\n\t\n\
    \x02\x03\0\x12\x03\x04\0\x1b\n\x08\n\x01\x08\x12\x03\x06\0Q\n\t\n\x02\
    \x08\x0b\x12\x03\x06\0Q\n\x08\n\x01\x08\x12\x03\x07\0*\n\t\n\x02\x08-\
    \x12\x03\x07\0*\n\n\n\x02\x05\0\x12\x04\t\0&\x01\n\n\n\x03\x05\0\x01\x12\
    \x03\t\x05\x0f\n\x87\x01\n\x04\x05\0\x02\0\x12\x03\x0c\x02\x18\x1az\x20U\
    nset\x20status.\x20This\x20should\x20never\x20be\x20returned\x20by\x20th\
    e\x20SDK.\x20If\x20it\x20does,\x20it\x20is\n\x20probably\x20a\x20bug\x20\
    (and\x20you\x20should\x20file\x20an\x20issue)\n\n\x0c\n\x05\x05\0\x02\0\
    \x01\x12\x03\x0c\x02\x13\n\x0c\n\x05\x05\0\x02\0\x02\x12\x03\x0c\x16\x17\
    \nD\n\x04\x05\0\x02\x01\x12\x03\x0f\x02\x17\x1a7\x20Indicates\x20that\
    \x20the\x20step\x20execution\x20evaluated\x20to\x20\"true\"\n\n\x0c\n\
    \x05\x05\0\x02\x01\x01\x12\x03\x0f\x02\x12\n\x0c\n\x05\x05\0\x02\x01\x02\
    \x12\x03\x0f\x15\x16\nE\n\x04\x05\0\x02\x02\x12\x03\x12\x02\x18\x1a8\x20\
    Indicates\x20that\x20the\x20step\x20execution\x20evaluated\x20to\x20\"fa\
    lse\"\n\n\x0c\n\x05\x05\0\x02\x02\x01\x12\x03\x12\x02\x13\n\x0c\n\x05\
    \x05\0\x02\x02\x02\x12\x03\x12\x16\x17\n\xd6\x01\n\x04\x05\0\x02\x03\x12\
    \x03\x17\x02\x18\x1a\xc8\x01\x20Indicates\x20that\x20the\x20SDK\x20encou\
    ntered\x20an\x20error\x20while\x20trying\x20to\x20process\x20the\n\x20re\
    quest.\x20Example\x20error\x20cases:\x20SDK\x20can't\x20find\x20the\x20a\
    ppropriate\x20Wasm\x20module,\n\x20Wasm\x20function\x20cannot\x20alloc\
    \x20or\x20dealloc\x20memory,\x20etc.\n\n\x0c\n\x05\x05\0\x02\x03\x01\x12\
    \x03\x17\x02\x13\n\x0c\n\x05\x05\0\x02\x03\x02\x12\x03\x17\x16\x17\n\x97\
    \x01\n\x04\x05\0\x02\x04\x12\x03\x1b\x02\x18\x1a\x89\x01\x20Indicates\
    \x20that\x20the\x20SDK\x20was\x20configured\x20to\x20operate\x20in\x20as\
    ync\x20mode.\n\x20Step\x20execution\x20will\x20occur\x20asynchronously\
    \x20in\x20a\x20background\x20worker-group.\n\n\x0c\n\x05\x05\0\x02\x04\
    \x01\x12\x03\x1b\x02\x13\n\x0c\n\x05\x05\0\x02\x04\x02\x12\x03\x1b\x16\
    \x17\n\x91\x03\n\x04\x05\0\x02\x05\x12\x03%\x02\x1b\x1a\x83\x03\x20Indic\
    ates\x20that\x20the\x20SDK\x20was\x20configured\x20to\x20operate\x20in\
    \x20sampling\x20mode.\n\x20Step\x20execution\x20was\x20skipped\x20for\
    \x20this\x20request\x20due\x20to\x20configured\x20sampling\x20rate.\n\n\
    \x20If\x20this\x20status\x20is\x20set,\x20you\x20can\x20safely\x20ignore\
    \x20the\x20rest\x20of\x20the\x20response\x20as\n\x20the\x20execution\x20\
    for\x20this\x20request\x20was\x20skipped\x20due\x20to\x20being\x20sample\
    d\x20out.\n\n\x20Non-sampled\x20messages\x20will\x20have\x20TRUE/FALSE/E\
    RROR\x20status\x20set\x20as\x20any\x20other\n\x20non-sampled\x20message.\
    \n\n\x0c\n\x05\x05\0\x02\x05\x01\x12\x03%\x02\x16\n\x0c\n\x05\x05\0\x02\
    \x05\x02\x12\x03%\x19\x1a\n\n\n\x02\x05\x01\x12\x04(\05\x01\n\n\n\x03\
    \x05\x01\x01\x12\x03(\x05\x0c\n\x0b\n\x04\x05\x01\x02\0\x12\x03)\x02\x15\
    \n\x0c\n\x05\x05\x01\x02\0\x01\x12\x03)\x02\x10\n\x0c\n\x05\x05\x01\x02\
    \0\x02\x12\x03)\x13\x14\n\xb1\x01\n\x04\x05\x01\x02\x01\x12\x03.\x02\x14\
    \x1a\xa3\x01\x20Process()\x20will\x20handle\x20the\x20message\x20inline.\
    \n\x20This\x20method\x20should\x20be\x20used\x20when\x20you\x20need\x20t\
    o\x20modify\x20the\x20input\x20data\x20and\x20pass\n\x20the\x20modified\
    \x20data\x20back\x20to\x20your\x20application\n\n\x0c\n\x05\x05\x01\x02\
    \x01\x01\x12\x03.\x02\x0f\n\x0c\n\x05\x05\x01\x02\x01\x02\x12\x03.\x12\
    \x13\n\x93\x02\n\x04\x05\x01\x02\x02\x12\x034\x02\x15\x1a\x85\x02\x20Pro\
    cess()\x20will\x20handle\x20the\x20message\x20asynchronously\x20in\x20a\
    \x20worker.\n\x20The\x20SDKResponse\x20will\x20not\x20contain\x20any\x20\
    modified\x20data.\x20This\x20mode\x20should\n\x20only\x20be\x20used\x20w\
    hen\x20you\x20don't\x20need\x20to\x20modify\x20and\x20pass\x20it\x20back\
    \x20to\x20your\n\x20application,\x20such\x20as\x20when\x20discovering/mo\
    nitoring\x20PII\x20only\n\n\x0c\n\x05\x05\x01\x02\x02\x01\x12\x034\x02\
    \x10\n\x0c\n\x05\x05\x01\x02\x02\x02\x12\x034\x13\x14\n5\n\x02\x04\0\x12\
    \x048\0R\x01\x1a)\x20Common\x20return\x20response\x20used\x20by\x20all\
    \x20SDKs\n\n\n\n\x03\x04\0\x01\x12\x038\x08\x13\n9\n\x04\x04\0\x02\0\x12\
    \x03:\x02\x11\x1a,\x20Contains\x20(potentially)\x20modified\x20input\x20\
    data\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03:\x02\x07\n\x0c\n\x05\x04\0\
    \x02\0\x01\x12\x03:\x08\x0c\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03:\x0f\x10\
    \n0\n\x04\x04\0\x02\x01\x12\x03=\x02\x18\x1a#\x20Execution\x20status\x20\
    of\x20the\x20last\x20step\n\n\x0c\n\x05\x04\0\x02\x01\x06\x12\x03=\x02\
    \x0c\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03=\r\x13\n\x0c\n\x05\x04\0\x02\
    \x01\x03\x12\x03=\x16\x17\nN\n\x04\x04\0\x02\x02\x12\x03@\x02%\x1aA\x20O\
    ptional\x20message\x20accompanying\x20the\x20exec\x20status\x20for\x20th\
    e\x20last\x20step\n\n\x0c\n\x05\x04\0\x02\x02\x04\x12\x03@\x02\n\n\x0c\n\
    \x05\x04\0\x02\x02\x05\x12\x03@\x0b\x11\n\x0c\n\x05\x04\0\x02\x02\x01\
    \x12\x03@\x12\x20\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03@#$\nV\n\x04\x04\
    \0\x02\x03\x12\x03C\x02.\x1aI\x20An\x20array\x20of\x20pipelines\x20that\
    \x20the\x20SDK\x20executed\x20and\x20the\x20status\x20of\x20each\x20step\
    \n\n\x0c\n\x05\x04\0\x02\x03\x04\x12\x03C\x02\n\n\x0c\n\x05\x04\0\x02\
    \x03\x06\x12\x03C\x0b\x19\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03C\x1a)\n\
    \x0c\n\x05\x04\0\x02\x03\x03\x12\x03C,-\n\x92\x03\n\x04\x04\0\x02\x04\
    \x12\x03M\x02#\x1a\x84\x03\x20Includes\x20any\x20metadata\x20that\x20the\
    ...
    \n\n\x0c\n\x05\x04\0\x02\x04\x06\x12\x03M\x02\x15\n\x0c\n\x05\x04\0\x02\
    \x04\x01\x12\x03M\x16\x1e\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03M!\"\n\
    \x91\x01\n\x04\x04\0\x02\x05\x12\x03Q\x02\x17\x1a\x83\x01\x20SDKMode\x20\
    is\x20purely\x20an\x20informative\x20field\x20that\x20tells\x20the\x20us\
    er\x20the\x20mode\x20that\x20the\n\x20SDK\x20was\x20running\x20in\x20whe\
    n\x20the\x20response\x20was\x20generated.\n\n\x0c\n\x05\x04\0\x02\x05\
    \x06\x12\x03Q\x02\t\n\x0c\n\x05\x04\0\x02\x05\x01\x12\x03Q\n\x12\n\x0c\n\
    \x05\x04\0\x02\x05\x03\x12\x03Q\x15\x16\n\n\n\x02\x04\x01\x12\x04T\0]\
    \x01\n\n\n\x03\x04\x01\x01\x12\x03T\x08\x16\n!\n\x04\x04\x01\x02\0\x12\
    \x03V\x02\x10\x1a\x14\x20ID\x20of\x20the\x20pipeline\n\n\x0c\n\x05\x04\
    \x01\x02\0\x05\x12\x03V\x02\x08\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03V\t\
    \x0b\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03V\x0e\x0f\n'\n\x04\x04\x01\x02\
    \x01\x12\x03Y\x02\x12\x1a\x1a\x20The\x20name\x20of\x20the\x20pipeline\n\
    \n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x03Y\x02\x08\n\x0c\n\x05\x04\x01\
    \x02\x01\x01\x12\x03Y\t\r\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03Y\x10\
    \x11\n6\n\x04\x04\x01\x02\x02\x12\x03\\\x02&\x1a)\x20The\x20status\x20of\
    \x20each\x20step\x20in\x20the\x20pipeline\n\n\x0c\n\x05\x04\x01\x02\x02\
    \x04\x12\x03\\\x02\n\n\x0c\n\x05\x04\x01\x02\x02\x06\x12\x03\\\x0b\x15\n\
    \x0c\n\x05\x04\x01\x02\x02\x01\x12\x03\\\x16!\n\x0c\n\x05\x04\x01\x02\
    \x02\x03\x12\x03\\$%\n\n\n\x02\x04\x02\x12\x04_\0o\x01\n\n\n\x03\x04\x02\
    \x01\x12\x03_\x08\x12\n#\n\x04\x04\x02\x02\0\x12\x03a\x02\x12\x1a\x16\
    \x20The\x20name\x20of\x20the\x20step\n\n\x0c\n\x05\x04\x02\x02\0\x05\x12\
    \x03a\x02\x08\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03a\t\r\n\x0c\n\x05\x04\
    \x02\x02\0\x03\x12\x03a\x10\x11\n3\n\x04\x04\x02\x02\x01\x12\x03d\x02\
    \x18\x1a&\x20Execution\x20outcome\x20status\x20of\x20the\x20step\n\n\x0c\
    \n\x05\x04\x02\x02\x01\x06\x12\x03d\x02\x0c\n\x0c\n\x05\x04\x02\x02\x01\
    \x01\x12\x03d\r\x13\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\x03d\x16\x17\n<\
    \n\x04\x04\x02\x02\x02\x12\x03g\x02%\x1a/\x20Optional\x20message\x20acco\
    mpanying\x20the\x20exec\x20status\n\n\x0c\n\x05\x04\x02\x02\x02\x04\x12\
    \x03g\x02\n\n\x0c\n\x05\x04\x02\x02\x02\x05\x12\x03g\x0b\x11\n\x0c\n\x05\
    \x04\x02\x02\x02\x01\x12\x03g\x12\x20\n\x0c\n\x05\x04\x02\x02\x02\x03\
    \x12\x03g#$\n\xf0\x01\n\x04\x04\x02\x02\x03\x12\x03n\x02%\x1a\xe2\x01\
    \x20Indicates\x20if\x20current\x20or\x20all\x20future\x20pipelines\x20we\
    re\x20aborted.\n\n\x20IMPORTANT:\x20The\x20SDK\x20running\x20into\x20an\
    \x20error\x20does\x20not\x20automatically\x20abort\n\x20current\x20or\
    \x20all\x20future\x20pipelines\x20-\x20the\x20user\x20must\x20define\x20\
    the\x20abort\x20conditions\n\x20for\x20\"on_error\".\n\n\x0c\n\x05\x04\
    \x02\x02\x03\x06\x12\x03n\x02\x10\n\x0c\n\x05\x04\x02\x02\x03\x01\x12\
    \x03n\x11\x20\n\x0c\n\x05\x04\x02\x02\x03\x03\x12\x03n#$b\x06proto3\
";
