...
pub struct Wasm {
    ...
    // @@protoc_insertion_point(field:protos.Wasm.bytes)
    pub bytes: ::std::vec::Vec<u8>,
    ///  Entry point function name
    // @@protoc_insertion_point(field:protos.Wasm.function_name)
    ...
    // @@protoc_insertion_point(field:protos.Wasm._bundled)
    pub _bundled: bool,
...
impl Wasm {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "bytes",
            |m: &Wasm| { &m.bytes },
            |m: &mut Wasm| { &mut m.bytes },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "function_name",
            |m: &Wasm| { &m.function_name },
            |m: &mut Wasm| { &mut m.function_name },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "_bundled",
            |m: &Wasm| { &m._bundled },
            |m: &mut Wasm| { &mut m._bundled },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "description",
...
impl ::protobuf::Message for Wasm {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.function_name.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.function_name);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.function_name.is_empty() {
            os.write_string(4, &self.function_name)?;
        }
        if self._bundled != false {
            os.write_bool(5, self._bundled)?;
        }
        if let Some(v) = self.description.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x05bytes\x18\x03\x20\x01(\x0cR\x05bytes\x12#\n\rfunction_name\x18\x04\
    \x20\x01(\tR\x0cfunctionName\x12\x19\n\x08_bundled\x18\x05\x20\x01(\x08R\
    \x07Bundled\x12%\n\x0bdescription\x18e\x20\x01(\tH\0R\x0bdescription\x88\
    \x01\x01\x12\x1d\n\x07version\x18f\x20\x01(\tH\x01R\x07version\x88\x01\
    \x01\x12\x15\n\x03url\x18g\x20\x01(\tH\x02R\x03url\x88\x01\x01\x12>\n\
    \x1a_created_at_unix_ts_ns_utc\x18\xe8\x07\x20\x01(\x03H\x03R\x14Created\
    AtUnixTsNsUtc\x88\x01\x01\x12>\n\x1a_updated_at_unix_ts_ns_utc\x18\xe9\
    \x07\x20\x01(\x03H\x04R\x14UpdatedAtUnixTsNsUtc\x88\x01\x01B\x0e\n\x0c_d\
    escriptionB\n\n\x08_versionB\x06\n\x04_urlB\x1d\n\x1bX_created_at_unix_t\
    s_ns_utcB\x1d\n\x1bX_updated_at_unix_ts_ns_utc*u\n\x0cWASMExitCode\x12\
    \x18\n\x14WASM_EXIT_CODE_UNSET\x10\0\x12\x17\n\x13WASM_EXIT_CODE_TRUE\
    \x10\x01\x12\x18\n\x14WASM_EXIT_CODE_FALSE\x10\x02\x12\x18\n\x14WASM_EXI\
    T_CODE_ERROR\x10\x03B<Z:github.com/streamdal/streamdal/libs/protos/build\
    /go/protosJ\xa0\"\n\x06\x12\x04\0\0p\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\
    \n\x08\n\x01\x02\x12\x03\x02\0\x0f\n\t\n\x02\x03\0\x12\x03\x04\0\x1b\n\t\
    \n\x02\x03\x01\x12\x03\x05\0(\n\x08\n\x01\x08\x12\x03\x07\0Q\n\t\n\x02\
    \x08\x0b\x12\x03\x07\0Q\n\xea\x04\n\x02\x05\0\x12\x04\x18\0\x1d\x01\x1a\
    \xdd\x04\x20Included\x20in\x20Wasm\x20response;\x20the\x20SDK\x20should\
    \x20use\x20the\x20WASMExitCode\x20to\x20determine\n\x20what\x20to\x20do\
    \x20next\x20-\x20should\x20it\x20execute\x20next\x20step,\x20should\x20i\
    t\x20notify\x20or\x20should\x20it\n\x20stop\x20execution/abort\x20the\
    \x20rest\x20of\x20the\x20steps\x20in\x20current\x20or\x20all\x20pipeline\
    s.\n\n\x20Example:\n\n\x20a.\x20Wasm\x20func\x20returns\x20WASM_EXIT_COD\
    E_FALSE\x20-\x20read\x20PipelineStep.on_false\n\x20conditions\x20to\x20d\
    etermine\x20what\x20to\x20do\x20next.\n\n\x20b.\x20Wasm\x20func\x20retur\
    ns\x20WASM_EXIT_CODE_TRUE\x20-\x20read\x20PipelineStep.on_true\n\x20cond\
    itions\x20to\x20determine\x20what\x20to\x20do\x20next.\n\n\x20..\x20and\
    \x20so\x20on.\n\x20TODO:\x20This\x20might\x20be\x20a\x20dupe\x20-\x20sho\
    uld\x20Wasm\x20use\x20ExecStatus\x20instead\x20of\x20this?\n\x20protolin\
    t:disable:next\x20ENUM_FIELD_NAMES_PREFIX\n\n\n\n\x03\x05\0\x01\x12\x03\
    \x18\x05\x11\n\x0b\n\x04\x05\0\x02\0\x12\x03\x19\x02\x1b\n\x0c\n\x05\x05\
    \0\x02\0\x01\x12\x03\x19\x02\x16\n\x0c\n\x05\x05\0\x02\0\x02\x12\x03\x19\
    \x19\x1a\n\x0b\n\x04\x05\0\x02\x01\x12\x03\x1a\x02\x1a\n\x0c\n\x05\x05\0\
    \x02\x01\x01\x12\x03\x1a\x02\x15\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03\
    \x1a\x18\x19\n\x0b\n\x04\x05\0\x02\x02\x12\x03\x1b\x02\x1b\n\x0c\n\x05\
    \x05\0\x02\x02\x01\x12\x03\x1b\x02\x16\n\x0c\n\x05\x05\0\x02\x02\x02\x12\
    \x03\x1b\x19\x1a\n\x0b\n\x04\x05\0\x02\x03\x12\x03\x1c\x02\x1b\n\x0c\n\
    \x05\x05\0\x02\x03\x01\x12\x03\x1c\x02\x16\n\x0c\n\x05\x05\0\x02\x03\x02\
    \x12\x03\x1c\x19\x1a\nK\n\x02\x04\0\x12\x04\x20\01\x01\x1a?\x20SDK\x20ge\
    nerates\x20a\x20WASM\x20request\x20and\x20passes\x20this\x20to\x20the\
    \x20WASM\x20func\n\n\n\n\x03\x04\0\x01\x12\x03\x20\x08\x13\n~\n\x04\x04\
    \0\x02\0\x12\x03#\x02\x1f\x1aq\x20The\x20actual\x20step\x20that\x20the\
    \x20WASM\x20func\x20will\x20operate\x20on.\x20This\x20is\x20the\x20same\
    ...
    \0\x02\x01\x12\x03&\x02\x1a\x1a-\x20Payload\x20data\x20that\x20WASM\x20f\
    unc\x20will\x20operate\x20on\n\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03&\
    \x02\x07\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03&\x08\x15\n\x0c\n\x05\x04\
    \0\x02\x01\x03\x12\x03&\x18\x19\nz\n\x04\x04\0\x02\x02\x12\x03*\x02\x20\
    \x1am\x20Potentially\x20filled\x20out\x20result\x20from\x20previous\x20s\
    tep.\x20If\x20this\x20is\x20first\x20step\x20in\n\x20the\x20pipeline,\
    \x20it\x20will\x20be\x20empty.\n\n\x0c\n\x05\x04\0\x02\x02\x04\x12\x03*\
    \x02\n\n\x0c\n\x05\x04\0\x02\x02\x05\x12\x03*\x0b\x10\n\x0c\n\x05\x04\0\
    \x02\x02\x01\x12\x03*\x11\x1b\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03*\x1e\
    \x1f\n\x88\x02\n\x04\x04\0\x02\x03\x12\x030\x021\x1a\xfa\x01\x20Potentia\
    l\x20input\x20from\x20a\x20previous\x20step\x20if\x20`Step.Dynamic\x20==\
    \x20true`\n\x20This\x20is\x20used\x20for\x20communicating\x20data\x20bet\
    ween\x20steps.\n\x20For\x20example,\x20when\x20trying\x20to\x20find\x20e\
    mail\x20addresses\x20in\x20a\x20payload\x20and\n\x20then\x20passing\x20o\
    n\x20the\x20results\x20to\x20a\x20transform\x20step\x20to\x20obfuscate\
    \x20them\n\n\x0c\n\x05\x04\0\x02\x03\x04\x12\x030\x02\n\n\x0c\n\x05\x04\
    \0\x02\x03\x06\x12\x030\x0b\x1a\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x030\
    \x1b,\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x030/0\n,\n\x02\x04\x01\x12\x044\
    \0J\x01\x1a\x20\x20Returned\x20by\x20all\x20WASM\x20functions\n\n\n\n\
    \x03\x04\x01\x01\x12\x034\x08\x14\n\xd2\x01\n\x04\x04\x01\x02\0\x12\x038\
    \x02\x1b\x1a\xc4\x01\x20Potentially\x20modified\x20input\x20payload.\x20\
    Concept:\x20All\x20WASM\x20funcs\x20accept\x20an\n\x20input_payload\x20i\
    n\x20WASMRequest,\x20WASM\x20func\x20reads\x20input\x20payload,\x20modif\
    ies\x20it\n\x20and\x20writes\x20the\x20modified\x20output\x20to\x20outpu\
    t_payload.\n\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x038\x02\x07\n\x0c\n\x05\
    \x04\x01\x02\0\x01\x12\x038\x08\x16\n\x0c\n\x05\x04\x01\x02\0\x03\x12\
    \x038\x19\x1a\n\\\n\x04\x04\x01\x02\x01\x12\x03;\x02\x1d\x1aO\x20Exit\
    \x20code\x20that\x20the\x20WASM\x20func\x20exited\x20with;\x20more\x20in\
    fo\x20in\x20WASMExitCode's\x20comment\n\n\x0c\n\x05\x04\x01\x02\x01\x06\
    \x12\x03;\x02\x0e\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x03;\x0f\x18\n\x0c\
    \n\x05\x04\x01\x02\x01\x03\x12\x03;\x1b\x1c\nQ\n\x04\x04\x01\x02\x02\x12\
    \x03>\x02\x16\x1aD\x20Additional\x20info\x20about\x20the\x20reason\x20a\
    \x20specific\x20exit\x20code\x20was\x20returned\n\n\x0c\n\x05\x04\x01\
    \x02\x02\x05\x12\x03>\x02\x08\n\x0c\n\x05\x04\x01\x02\x02\x01\x12\x03>\t\
    \x11\n\x0c\n\x05\x04\x01\x02\x02\x03\x12\x03>\x14\x15\n\xdc\x01\n\x04\
    \x04\x01\x02\x03\x12\x03C\x02!\x1a\xce\x01\x20Potential\x20additional\
    \x20step\x20output\x20-\x20ie.\x20if\x20a\x20WASM\x20func\x20is\x20an\
    \x20HTTPGet,\n\x20output_step\x20would\x20contain\x20the\x20HTTP\x20resp\
    onse\x20body;\x20if\x20the\x20WASM\x20func\x20is\x20a\n\x20KVGet,\x20the\
    \x20output_step\x20would\x20be\x20the\x20value\x20of\x20the\x20fetched\
    \x20key.\n\n\x0c\n\x05\x04\x01\x02\x03\x04\x12\x03C\x02\n\n\x0c\n\x05\
    \x04\x01\x02\x03\x05\x12\x03C\x0b\x10\n\x0c\n\x05\x04\x01\x02\x03\x01\
    \x12\x03C\x11\x1c\n\x0c\n\x05\x04\x01\x02\x03\x03\x12\x03C\x1f\x20\n\x97\
    \x02\n\x04\x04\x01\x02\x04\x12\x03I\x021\x1a\x89\x02\x20If\x20`Step.Dyna\
    mic\x20==\x20true`,\x20this\x20field\x20should\x20be\x20filled\x20out\
    \x20by\x20the\x20WASM\x20module\n\x20This\x20is\x20used\x20for\x20commun\
    icating\x20data\x20between\x20steps.\n\x20For\x20example,\x20when\x20try\
    ing\x20to\x20find\x20email\x20addresses\x20in\x20a\x20payload\x20and\n\
    \x20then\x20passing\x20on\x20the\x20results\x20to\x20a\x20transform\x20s\
    tep\x20to\x20obfuscate\x20them\n\n\x0c\n\x05\x04\x01\x02\x04\x04\x12\x03\
    I\x02\n\n\x0c\n\x05\x04\x01\x02\x04\x06\x12\x03I\x0b\x1a\n\x0c\n\x05\x04\
    \x01\x02\x04\x01\x12\x03I\x1b,\n\x0c\n\x05\x04\x01\x02\x04\x03\x12\x03I/\
    0\n\x98\x01\n\x02\x04\x02\x12\x04N\0R\x01\x1a\x8b\x01\x20Intended\x20for\
    \x20communicating\x20wasm\x20results\x20between\x20steps.\n\x20Currently\
    \x20only\x20used\x20for\x20passing\x20results\x20from\x20a\x20Detective\
    \x20Step\x20to\x20a\x20Transform\x20step\n\n\n\n\x03\x04\x02\x01\x12\x03\
    N\x08\x17\n\x0c\n\x04\x04\x02\x08\0\x12\x04O\x02Q\x03\n\x0c\n\x05\x04\
    \x02\x08\0\x01\x12\x03O\x08\x12\n\x0b\n\x04\x04\x02\x02\0\x12\x03P\x043\
    \n\x0c\n\x05\x04\x02\x02\0\x06\x12\x03P\x04\x1d\n\x0c\n\x05\x04\x02\x02\
    \0\x01\x12\x03P\x1e.\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x03P12\nG\n\x02\
    \x04\x03\x12\x04U\0p\x01\x1a;\x20Used\x20for\x20referencing\x20both\x20b\
    undled\x20and\x20custom\x20wasm\x20modules\n\n\n\n\x03\x04\x03\x01\x12\
    \x03U\x08\x0c\n6\n\x04\x04\x03\x02\0\x12\x03W\x02\x10\x1a)\x20ID\x20used\
    \x20for\x20referencing\x20the\x20Wasm\x20module\n\n\x0c\n\x05\x04\x03\
    \x02\0\x05\x12\x03W\x02\x08\n\x0c\n\x05\x04\x03\x02\0\x01\x12\x03W\t\x0b\
    \n\x0c\n\x05\x04\x03\x02\0\x03\x12\x03W\x0e\x0f\n0\n\x04\x04\x03\x02\x01\
    \x12\x03Z\x02\x12\x1a#\x20Friendly\x20name\x20for\x20the\x20Wasm\x20modu\
    le\n\n\x0c\n\x05\x04\x03\x02\x01\x05\x12\x03Z\x02\x08\n\x0c\n\x05\x04\
    \x03\x02\x01\x01\x12\x03Z\t\r\n\x0c\n\x05\x04\x03\x02\x01\x03\x12\x03Z\
    \x10\x11\n*\n\x04\x04\x03\x02\x02\x12\x03]\x02\x12\x1a\x1d\x20Contents\
    \x20of\x20the\x20Wasm\x20module\n\n\x0c\n\x05\x04\x03\x02\x02\x05\x12\
    \x03]\x02\x07\n\x0c\n\x05\x04\x03\x02\x02\x01\x12\x03]\x08\r\n\x0c\n\x05\
    \x04\x03\x02\x02\x03\x12\x03]\x10\x11\n(\n\x04\x04\x03\x02\x03\x12\x03`\
    \x02\x1b\x1a\x1b\x20Entry\x20point\x20function\x20name\n\n\x0c\n\x05\x04\
    \x03\x02\x03\x05\x12\x03`\x02\x08\n\x0c\n\x05\x04\x03\x02\x03\x01\x12\
    \x03`\t\x16\n\x0c\n\x05\x04\x03\x02\x03\x03\x12\x03`\x19\x1a\n\xcb\x01\n\
    \x04\x04\x03\x02\x04\x12\x03d\x02\x14\x1a\x86\x01\x20Indicates\x20whethe\
    r\x20this\x20wasm\x20entry\x20is\x20for\x20bundled\x20wasm\x20or\x20for\
    \x20wasm\x20added\x20via\n\x20CreateWasm();\x20ignored\x20in\x20CreateWa\
    sm()\x20and\x20UpdateWasm().\n\"5\x20protolint:disable:this\x20FIELD_NAM\
    ES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\x03\x02\x04\x05\x12\x03d\x02\x06\n\
    \x0c\n\x05\x04\x03\x02\x04\x01\x12\x03d\x07\x0f\n\x0c\n\x05\x04\x03\x02\
    \x04\x03\x12\x03d\x12\x13\n(\n\x04\x04\x03\x02\x05\x12\x03g\x02$\x1a\x1b\
    \x20Informative,\x20debug\x20fields\n\n\x0c\n\x05\x04\x03\x02\x05\x04\
    \x12\x03g\x02\n\n\x0c\n\x05\x04\x03\x02\x05\x05\x12\x03g\x0b\x11\n\x0c\n\
    \x05\x04\x03\x02\x05\x01\x12\x03g\x12\x1d\n\x0c\n\x05\x04\x03\x02\x05\
    \x03\x12\x03g\x20#\n\x0b\n\x04\x04\x03\x02\x06\x12\x03h\x02\x20\n\x0c\n\
    \x05\x04\x03\x02\x06\x04\x12\x03h\x02\n\n\x0c\n\x05\x04\x03\x02\x06\x05\
    \x12\x03h\x0b\x11\n\x0c\n\x05\x04\x03\x02\x06\x01\x12\x03h\x12\x19\n\x0c\
    \n\x05\x04\x03\x02\x06\x03\x12\x03h\x1c\x1f\n\x0b\n\x04\x04\x03\x02\x07\
    \x12\x03i\x02\x1c\n\x0c\n\x05\x04\x03\x02\x07\x04\x12\x03i\x02\n\n\x0c\n\
    \x05\x04\x03\x02\x07\x05\x12\x03i\x0b\x11\n\x0c\n\x05\x04\x03\x02\x07\
    \x01\x12\x03i\x12\x15\n\x0c\n\x05\x04\x03\x02\x07\x03\x12\x03i\x18\x1b\n\
    S\n\x04\x04\x03\x02\x08\x12\x03l\x023\x1a\x0f\x20Set\x20by\x20server\n\"\
    5\x20protolint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\
    \x05\x04\x03\x02\x08\x04\x12\x03l\x02\n\n\x0c\n\x05\x04\x03\x02\x08\x05\
    \x12\x03l\x0b\x10\n\x0c\n\x05\x04\x03\x02\x08\x01\x12\x03l\x11+\n\x0c\n\
    \x05\x04\x03\x02\x08\x03\x12\x03l.2\nS\n\x04\x04\x03\x02\t\x12\x03o\x023\
    \x1a\x0f\x20Set\x20by\x20server\n\"5\x20protolint:disable:this\x20FIELD_\
    NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\x03\x02\t\x04\x12\x03o\x02\n\n\
    \x0c\n\x05\x04\x03\x02\t\x05\x12\x03o\x0b\x10\n\x0c\n\x05\x04\x03\x02\t\
    \x01\x12\x03o\x11+\n\x0c\n\x05\x04\x03\x02\t\x03\x12\x03o.2b\x06proto3\
";
