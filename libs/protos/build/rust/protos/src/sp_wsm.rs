...
pub struct WASMRequest {
    ...
    // @@protoc_insertion_point(field:protos.WASMRequest.data_format)
    pub data_format: ::protobuf::EnumOrUnknown<super::sp_pipeline::PipelineDataFormat>,
    // special fields
...
impl WASMRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "data_format",
            |m: &WASMRequest| { &m.data_format },
            |m: &mut WASMRequest| { &mut m.data_format },
        ));
...
impl ::protobuf::Message for WASMRequest {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.data_format != ::protobuf::EnumOrUnknown::new(super::sp_pipeline::PipelineDataFormat::PIPELINE_DATA_FORMAT_UNSET) {
    ...
    fn clear(&mut self) {
        ...
        self.data_format = ::protobuf::EnumOrUnknown::new(super::sp_pipeline::PipelineDataFormat::PIPELINE_DATA_FORMAT_UNSET);
...
pub struct InterStepResult {
    // message fields
    // @@protoc_insertion_point(field:protos.InterStepResult.audience)
...
impl InterStepResult {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::sp_common::Audience>(
            "audience",
            |m: &InterStepResult| { &m.audience },
            |m: &mut InterStepResult| { &mut m.audience },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0csp_wsm.proto\x12\x06protos\x1a\x0fsp_common.proto\x1a\x11sp_pipeli\
    ne.proto\x1a\x1esteps/sp_steps_detective.proto\"\xac\x02\n\x0bWASMReques\
    t\x12(\n\x04step\x18\x01\x20\x01(\x0b2\x14.protos.PipelineStepR\x04step\
    \x12#\n\rinput_payload\x18\x02\x20\x01(\x0cR\x0cinputPayload\x12\"\n\nin\
    put_step\x18\x03\x20\x01(\x0cH\0R\tinputStep\x88\x01\x01\x12H\n\x11inter\
    _step_result\x18\x04\x20\x01(\x0b2\x17.protos.InterStepResultH\x01R\x0fi\
    nterStepResult\x88\x01\x01\x12;\n\x0bdata_format\x18\x05\x20\x01(\x0e2\
    \x1a.protos.PipelineDataFormatR\ndataFormatB\r\n\x0b_input_stepB\x14\n\
    \x12_inter_step_result\"\x99\x02\n\x0cWASMResponse\x12%\n\x0eoutput_payl\
    oad\x18\x01\x20\x01(\x0cR\routputPayload\x121\n\texit_code\x18\x02\x20\
    \x01(\x0e2\x14.protos.WASMExitCodeR\x08exitCode\x12\x19\n\x08exit_msg\
    \x18\x03\x20\x01(\tR\x07exitMsg\x12$\n\x0boutput_step\x18\x04\x20\x01(\
    \x0cH\0R\noutputStep\x88\x01\x01\x12H\n\x11inter_step_result\x18\x05\x20\
    \x01(\x0b2\x17.protos.InterStepResultH\x01R\x0finterStepResult\x88\x01\
    \x01B\x0e\n\x0c_output_stepB\x14\n\x12_inter_step_result\"\x9e\x01\n\x0f\
    InterStepResult\x12N\n\x10detective_result\x18\x01\x20\x01(\x0b2!.protos\
    .steps.DetectiveStepResultH\0R\x0fdetectiveResult\x12-\n\x08audience\x18\
    \xe8\x07\x20\x01(\x0b2\x10.protos.AudienceR\x08audienceB\x0c\n\ninput_fr\
    ...
    \x02\x12\x18\n\x14WASM_EXIT_CODE_ERROR\x10\x03BPZ:github.com/streamdal/s\
    treamdal/libs/protos/build/go/protos\xea\x02\x11Streamdal::ProtosJ\xc2\
    \x1a\n\x06\x12\x04\0\0Y\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\
    \x02\x12\x03\x02\0\x0f\n\t\n\x02\x03\0\x12\x03\x04\0\x19\n\t\n\x02\x03\
    \x01\x12\x03\x05\0\x1b\n\t\n\x02\x03\x02\x12\x03\x06\0(\n\x08\n\x01\x08\
    \x12\x03\x08\0Q\n\t\n\x02\x08\x0b\x12\x03\x08\0Q\n\x08\n\x01\x08\x12\x03\
    \t\0*\n\t\n\x02\x08-\x12\x03\t\0*\n\xea\x04\n\x02\x05\0\x12\x04\x1a\0\
    \x1f\x01\x1a\xdd\x04\x20Included\x20in\x20Wasm\x20response;\x20the\x20SD\
    K\x20should\x20use\x20the\x20WASMExitCode\x20to\x20determine\n\x20what\
    \x20to\x20do\x20next\x20-\x20should\x20it\x20execute\x20next\x20step,\
    \x20should\x20it\x20notify\x20or\x20should\x20it\n\x20stop\x20execution/\
    abort\x20the\x20rest\x20of\x20the\x20steps\x20in\x20current\x20or\x20all\
    \x20pipelines.\n\n\x20Example:\n\n\x20a.\x20Wasm\x20func\x20returns\x20W\
    ASM_EXIT_CODE_FALSE\x20-\x20read\x20PipelineStep.on_false\n\x20condition\
    s\x20to\x20determine\x20what\x20to\x20do\x20next.\n\n\x20b.\x20Wasm\x20f\
    unc\x20returns\x20WASM_EXIT_CODE_TRUE\x20-\x20read\x20PipelineStep.on_tr\
    ue\n\x20conditions\x20to\x20determine\x20what\x20to\x20do\x20next.\n\n\
    \x20..\x20and\x20so\x20on.\n\x20TODO:\x20This\x20might\x20be\x20a\x20dup\
    e\x20-\x20should\x20Wasm\x20use\x20ExecStatus\x20instead\x20of\x20this?\
    \n\x20protolint:disable:next\x20ENUM_FIELD_NAMES_PREFIX\n\n\n\n\x03\x05\
    \0\x01\x12\x03\x1a\x05\x11\n\x0b\n\x04\x05\0\x02\0\x12\x03\x1b\x02\x1b\n\
    \x0c\n\x05\x05\0\x02\0\x01\x12\x03\x1b\x02\x16\n\x0c\n\x05\x05\0\x02\0\
    \x02\x12\x03\x1b\x19\x1a\n\x0b\n\x04\x05\0\x02\x01\x12\x03\x1c\x02\x1a\n\
    \x0c\n\x05\x05\0\x02\x01\x01\x12\x03\x1c\x02\x15\n\x0c\n\x05\x05\0\x02\
    \x01\x02\x12\x03\x1c\x18\x19\n\x0b\n\x04\x05\0\x02\x02\x12\x03\x1d\x02\
    \x1b\n\x0c\n\x05\x05\0\x02\x02\x01\x12\x03\x1d\x02\x16\n\x0c\n\x05\x05\0\
    \x02\x02\x02\x12\x03\x1d\x19\x1a\n\x0b\n\x04\x05\0\x02\x03\x12\x03\x1e\
    \x02\x1b\n\x0c\n\x05\x05\0\x02\x03\x01\x12\x03\x1e\x02\x16\n\x0c\n\x05\
    \x05\0\x02\x03\x02\x12\x03\x1e\x19\x1a\nK\n\x02\x04\0\x12\x04\"\06\x01\
    ...
    \n~\n\x04\x04\0\x02\0\x12\x03%\x02\x1f\x1aq\x20The\x20actual\x20step\x20\
    that\x20the\x20WASM\x20func\x20will\x20operate\x20on.\x20This\x20is\x20t\
    ...
    \x1f\n\x88\x02\n\x04\x04\0\x02\x03\x12\x032\x021\x1a\xfa\x01\x20Potentia\
    ...
    \0\x02\x03\x06\x12\x032\x0b\x1a\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x032\
    \x1b,\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x032/0\nZ\n\x04\x04\0\x02\x04\
    \x12\x035\x02%\x1aM\x20Data\x20format\x20of\x20the\x20input\x20payload.\
    \x20This\x20is\x20obtained\x20from\x20Pipeline.DataFormat\n\n\x0c\n\x05\
    \x04\0\x02\x04\x06\x12\x035\x02\x14\n\x0c\n\x05\x04\0\x02\x04\x01\x12\
    \x035\x15\x20\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x035#$\n,\n\x02\x04\x01\
    \x12\x049\0O\x01\x1a\x20\x20Returned\x20by\x20all\x20WASM\x20functions\n\
    \n\n\n\x03\x04\x01\x01\x12\x039\x08\x14\n\xd2\x01\n\x04\x04\x01\x02\0\
    \x12\x03=\x02\x1b\x1a\xc4\x01\x20Potentially\x20modified\x20input\x20pay\
    load.\x20Concept:\x20All\x20WASM\x20funcs\x20accept\x20an\n\x20input_pay\
    load\x20in\x20WASMRequest,\x20WASM\x20func\x20reads\x20input\x20payload,\
    \x20modifies\x20it\n\x20and\x20writes\x20the\x20modified\x20output\x20to\
    \x20output_payload.\n\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03=\x02\x07\n\
    \x0c\n\x05\x04\x01\x02\0\x01\x12\x03=\x08\x16\n\x0c\n\x05\x04\x01\x02\0\
    \x03\x12\x03=\x19\x1a\n\\\n\x04\x04\x01\x02\x01\x12\x03@\x02\x1d\x1aO\
    \x20Exit\x20code\x20that\x20the\x20WASM\x20func\x20exited\x20with;\x20mo\
    re\x20info\x20in\x20WASMExitCode's\x20comment\n\n\x0c\n\x05\x04\x01\x02\
    \x01\x06\x12\x03@\x02\x0e\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x03@\x0f\
    \x18\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03@\x1b\x1c\nQ\n\x04\x04\x01\
    \x02\x02\x12\x03C\x02\x16\x1aD\x20Additional\x20info\x20about\x20the\x20\
    reason\x20a\x20specific\x20exit\x20code\x20was\x20returned\n\n\x0c\n\x05\
    \x04\x01\x02\x02\x05\x12\x03C\x02\x08\n\x0c\n\x05\x04\x01\x02\x02\x01\
    \x12\x03C\t\x11\n\x0c\n\x05\x04\x01\x02\x02\x03\x12\x03C\x14\x15\n\xdc\
    \x01\n\x04\x04\x01\x02\x03\x12\x03H\x02!\x1a\xce\x01\x20Potential\x20add\
    itional\x20step\x20output\x20-\x20ie.\x20if\x20a\x20WASM\x20func\x20is\
    \x20an\x20HTTPGet,\n\x20output_step\x20would\x20contain\x20the\x20HTTP\
    \x20response\x20body;\x20if\x20the\x20WASM\x20func\x20is\x20a\n\x20KVGet\
    ,\x20the\x20output_step\x20would\x20be\x20the\x20value\x20of\x20the\x20f\
    etched\x20key.\n\n\x0c\n\x05\x04\x01\x02\x03\x04\x12\x03H\x02\n\n\x0c\n\
    \x05\x04\x01\x02\x03\x05\x12\x03H\x0b\x10\n\x0c\n\x05\x04\x01\x02\x03\
    \x01\x12\x03H\x11\x1c\n\x0c\n\x05\x04\x01\x02\x03\x03\x12\x03H\x1f\x20\n\
    \x97\x02\n\x04\x04\x01\x02\x04\x12\x03N\x021\x1a\x89\x02\x20If\x20`Step.\
    Dynamic\x20==\x20true`,\x20this\x20field\x20should\x20be\x20filled\x20ou\
    t\x20by\x20the\x20WASM\x20module\n\x20This\x20is\x20used\x20for\x20commu\
    nicating\x20data\x20between\x20steps.\n\x20For\x20example,\x20when\x20tr\
    ying\x20to\x20find\x20email\x20addresses\x20in\x20a\x20payload\x20and\n\
    ...
    N\x02\n\n\x0c\n\x05\x04\x01\x02\x04\x06\x12\x03N\x0b\x1a\n\x0c\n\x05\x04\
    \x01\x02\x04\x01\x12\x03N\x1b,\n\x0c\n\x05\x04\x01\x02\x04\x03\x12\x03N/\
    0\n\x98\x01\n\x02\x04\x02\x12\x04S\0Y\x01\x1a\x8b\x01\x20Intended\x20for\
    ...
    S\x08\x17\n\x0c\n\x04\x04\x02\x08\0\x12\x04T\x02V\x03\n\x0c\n\x05\x04\
    \x02\x08\0\x01\x12\x03T\x08\x12\n\x0b\n\x04\x04\x02\x02\0\x12\x03U\x043\
    \n\x0c\n\x05\x04\x02\x02\0\x06\x12\x03U\x04\x1d\n\x0c\n\x05\x04\x02\x02\
    \0\x01\x12\x03U\x1e.\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x03U12\n\x0b\n\
    \x04\x04\x02\x02\x01\x12\x03X\x02\"\n\x0c\n\x05\x04\x02\x02\x01\x06\x12\
    \x03X\x02\x11\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x03X\x12\x1a\n\x0c\n\
    \x05\x04\x02\x02\x01\x03\x12\x03X\x1d!b\x06proto3\
";
