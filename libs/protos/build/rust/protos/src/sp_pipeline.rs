...
pub struct PipelineStep {
    ...
    // @@protoc_insertion_point(field:protos.PipelineStep.wasm_precompiled)
    pub wasm_precompiled: bool,
...
impl PipelineStep {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "wasm_precompiled",
            |m: &PipelineStep| { &m.wasm_precompiled },
            |m: &mut PipelineStep| { &mut m.wasm_precompiled },
        ));
...
impl ::protobuf::Message for PipelineStep {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                80024 => {
                    self.wasm_precompiled = is.read_bool()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.wasm_precompiled != false {
            my_size += 3 + 1;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.wasm_precompiled != false {
            os.write_bool(10003, self.wasm_precompiled)?;
        }
        if let ::std::option::Option::Some(ref v) = self.step {
            match v {
                &pipeline_step::Step::Detective(ref v) => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    _TYPE_SELECT_PATHS\x10\x03\"\xa2\x08\n\x0cPipelineStep\x12\x12\n\x04name\
    ...
    \x92N\x20\x01(\tH\x03R\x0cWasmFunction\x88\x01\x01\x12*\n\x10wasm_precom\
    piled\x18\x93N\x20\x01(\x08R\x0fwasmPrecompiledB\x06\n\x04stepB\x0b\n\tX\
    ...
    o/protos\xea\x02\x11Streamdal::ProtosJ\xc1<\n\x07\x12\x05\0\0\xc1\x01\
    ...
    \xa7\x01\x01\x1a1\x20A\x20pipeline\x20step\x20is\x20a\x20single\x20step\
    ...
    \nC\n\x04\x04\x03\x02\x12\x12\x04\xa6\x01\x02\x20\"5\x20protolint:disabl\
    e:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\r\n\x05\x04\x03\x02\x12\x05\
    \x12\x04\xa6\x01\x02\x06\n\r\n\x05\x04\x03\x02\x12\x01\x12\x04\xa6\x01\
    \x07\x17\n\r\n\x05\x04\x03\x02\x12\x03\x12\x04\xa6\x01\x1a\x1f\n\x8a\x01\
    \n\x02\x04\x04\x12\x06\xab\x01\0\xb9\x01\x01\x1a|\x20PipelineConfigs\x20\
    is\x20stored\x20encoded\x20in\x20redis:streamdal_audience:$audStr;\x20it\
    \x20is\n\x20also\x20used\x20in\x20external.GetAllResponse:config.\n\n\
    \x0b\n\x03\x04\x04\x01\x12\x04\xab\x01\x08\x17\n\x0c\n\x04\x04\x04\x02\0\
    \x12\x04\xac\x01\x02&\n\r\n\x05\x04\x04\x02\0\x04\x12\x04\xac\x01\x02\n\
    \n\r\n\x05\x04\x04\x02\0\x06\x12\x04\xac\x01\x0b\x19\n\r\n\x05\x04\x04\
    \x02\0\x01\x12\x04\xac\x01\x1a!\n\r\n\x05\x04\x04\x02\0\x03\x12\x04\xac\
    \x01$%\n\xf1\x02\n\x04\x04\x04\x02\x01\x12\x04\xb5\x01\x02!\x1a\xab\x02\
    ...
    OWER_SNAKE_CASE\n\n\r\n\x05\x04\x04\x02\x01\x04\x12\x04\xb5\x01\x02\n\n\
    \r\n\x05\x04\x04\x02\x01\x05\x12\x04\xb5\x01\x0b\x0f\n\r\n\x05\x04\x04\
    \x02\x01\x01\x12\x04\xb5\x01\x10\x19\n\r\n\x05\x04\x04\x02\x01\x03\x12\
    \x04\xb5\x01\x1c\x20\n\xa0\x01\n\x04\x04\x04\x02\x02\x12\x04\xb8\x01\x02\
    %\x1a[\x20Used\x20internally\x20by\x20server\x20and\x20k8s\x20operator\
    \x20to\x20determine\x20who\x20manages\x20this\x20resource/mapping\n\"5\
    \x20protolint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\r\n\x05\
    \x04\x04\x02\x02\x04\x12\x04\xb8\x01\x02\n\n\r\n\x05\x04\x04\x02\x02\x05\
    \x12\x04\xb8\x01\x0b\x11\n\r\n\x05\x04\x04\x02\x02\x01\x12\x04\xb8\x01\
    \x12\x1d\n\r\n\x05\x04\x04\x02\x02\x03\x12\x04\xb8\x01\x20$\nJ\n\x02\x04\
    \x05\x12\x06\xbd\x01\0\xc1\x01\x01\x1a<\x20PipelineConfig\x20is\x20struc\
    ture\x20used\x20in\x20protos.PipelineConfigs\n\n\x0b\n\x03\x04\x05\x01\
    \x12\x04\xbd\x01\x08\x16\n\x0c\n\x04\x04\x05\x02\0\x12\x04\xbe\x01\x02\
    \x10\n\r\n\x05\x04\x05\x02\0\x05\x12\x04\xbe\x01\x02\x08\n\r\n\x05\x04\
    \x05\x02\0\x01\x12\x04\xbe\x01\t\x0b\n\r\n\x05\x04\x05\x02\0\x03\x12\x04\
    \xbe\x01\x0e\x0f\n\x0c\n\x04\x04\x05\x02\x01\x12\x04\xbf\x01\x02\x12\n\r\
    \n\x05\x04\x05\x02\x01\x05\x12\x04\xbf\x01\x02\x06\n\r\n\x05\x04\x05\x02\
    \x01\x01\x12\x04\xbf\x01\x07\r\n\r\n\x05\x04\x05\x02\x01\x03\x12\x04\xbf\
    \x01\x10\x11\n\x0c\n\x04\x04\x05\x02\x02\x12\x04\xc0\x01\x02#\n\r\n\x05\
    \x04\x05\x02\x02\x05\x12\x04\xc0\x01\x02\x07\n\r\n\x05\x04\x05\x02\x02\
    \x01\x12\x04\xc0\x01\x08\x1e\n\r\n\x05\x04\x05\x02\x02\x03\x12\x04\xc0\
    \x01!\"b\x06proto3\
";
