...
pub struct PipelineStep {
    ...
    pub on_success: ::protobuf::MessageField<PipelineStepConditions>,
    ...
    pub on_failure: ::protobuf::MessageField<PipelineStepConditions>,
...
impl ::protobuf::Message for PipelineStep {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.on_success)?;
                },
                26 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.on_failure)?;
                },
                32 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.on_success.as_ref() {
    ...
    fn default_instance() -> &'static PipelineStep {
        static instance: PipelineStep = PipelineStep {
            name: ::std::string::String::new(),
            on_success: ::protobuf::MessageField::none(),
            on_failure: ::protobuf::MessageField::none(),
            dynamic: false,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    *\n\x0e_wasm_function\x18\x92N\x20\x01(\tH\x03R\x0cWasmFunction\x88\x01\
    ...
    \nA\n\x02\x05\0\x12\x04&\0*\x01\x1a5\x20Defines\x20the\x20ways\x20in\x20\
    which\x20a\x20pipeline\x20can\x20be\x20aborted\n\n\n\n\x03\x05\0\x01\x12\
    ...
    \x04\x01\x12\x040\09\x01\x1a\xf5\x01\x20Conditions\x20define\x20how\x20t\
    ...
    uld\x20it\x20abort,\x20should\x20it\x20notify\n\x20the\x20server?\x20Eac\
    h\x20step\x20can\x20have\x20exactly\x20one\x20of\x20these\x20for\x20on_s\
    uccess,\x20on_failure\n\x20and\x20on_error.\n\n\n\n\x03\x04\x01\x01\x12\
    \x030\x08\x1e\n)\n\x04\x04\x01\x02\0\x12\x032\x02\x1b\x1a\x1c\x20Should\
    \x20we\x20abort\x20execution?\n\n\x0c\n\x05\x04\x01\x02\0\x06\x12\x032\
    \x02\x10\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x032\x11\x16\n\x0c\n\x05\x04\
    \x01\x02\0\x03\x12\x032\x19\x1a\n0\n\x04\x04\x01\x02\x01\x12\x035\x02\
    \x12\x1a#\x20Should\x20we\x20trigger\x20a\x20notification?\n\n\x0c\n\x05\
    \x04\x01\x02\x01\x05\x12\x035\x02\x06\n\x0c\n\x05\x04\x01\x02\x01\x01\
    \x12\x035\x07\r\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x035\x10\x11\nW\n\
    \x04\x04\x01\x02\x02\x12\x038\x02#\x1aJ\x20Should\x20we\x20include\x20ad\
    ditional\x20metadata\x20that\x20SDK\x20should\x20pass\x20back\x20to\x20u\
    ser?\n\n\x0c\n\x05\x04\x01\x02\x02\x06\x12\x038\x02\x15\n\x0c\n\x05\x04\
    \x01\x02\x02\x01\x12\x038\x16\x1e\n\x0c\n\x05\x04\x01\x02\x02\x03\x12\
    \x038!\"\n=\n\x02\x04\x02\x12\x04<\0a\x01\x1a1\x20A\x20pipeline\x20step\
    \x20is\x20a\x20single\x20step\x20in\x20a\x20pipeline.\n\n\n\n\x03\x04\
    ...
    \x03A\x02(\x1aN\x20SDKs\x20should\x20read\x20this\x20when\x20WASM\x20ret\
    urns\x20success\x20to\x20determine\x20what\x20to\x20do\x20next\n\n\x0c\n\
    \x05\x04\x02\x02\x01\x06\x12\x03A\x02\x18\n\x0c\n\x05\x04\x02\x02\x01\
    \x01\x12\x03A\x19#\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\x03A&'\n[\n\x04\
    \x04\x02\x02\x02\x12\x03D\x02(\x1aN\x20SDKs\x20should\x20read\x20this\
    \x20when\x20WASM\x20returns\x20failure\x20to\x20determine\x20what\x20to\
    \x20do\x20next\n\n\x0c\n\x05\x04\x02\x02\x02\x06\x12\x03D\x02\x18\n\x0c\
    \n\x05\x04\x02\x02\x02\x01\x12\x03D\x19#\n\x0c\n\x05\x04\x02\x02\x02\x03\
    \x12\x03D&'\n^\n\x04\x04\x02\x02\x03\x12\x03G\x02\x13\x1aQ\x20Indicates\
    \x20whether\x20to\x20use\x20the\x20results\x20from\x20a\x20previous\x20s\
    tep\x20as\x20input\x20to\x20this\x20step\n\n\x0c\n\x05\x04\x02\x02\x03\
    \x05\x12\x03G\x02\x06\n\x0c\n\x05\x04\x02\x02\x03\x01\x12\x03G\x07\x0e\n\
    \x0c\n\x05\x04\x02\x02\x03\x03\x12\x03G\x11\x12\nY\n\x04\x04\x02\x02\x04\
    \x12\x03J\x02&\x1aL\x20SDKs\x20should\x20read\x20this\x20when\x20WASM\
    \x20returns\x20error\x20to\x20determine\x20what\x20to\x20do\x20next\n\n\
    \x0c\n\x05\x04\x02\x02\x04\x06\x12\x03J\x02\x18\n\x0c\n\x05\x04\x02\x02\
    \x04\x01\x12\x03J\x19!\n\x0c\n\x05\x04\x02\x02\x04\x03\x12\x03J$%\n\x0c\
    \n\x04\x04\x02\x08\0\x12\x04L\x02W\x03\n\x0c\n\x05\x04\x02\x08\0\x01\x12\
    \x03L\x08\x0c\n\x0b\n\x04\x04\x02\x02\x05\x12\x03M\x04)\n\x0c\n\x05\x04\
    \x02\x02\x05\x06\x12\x03M\x04\x17\n\x0c\n\x05\x04\x02\x02\x05\x01\x12\
    \x03M\x18!\n\x0c\n\x05\x04\x02\x02\x05\x03\x12\x03M$(\n\x0b\n\x04\x04\
    \x02\x02\x06\x12\x03N\x04)\n\x0c\n\x05\x04\x02\x02\x06\x06\x12\x03N\x04\
    \x17\n\x0c\n\x05\x04\x02\x02\x06\x01\x12\x03N\x18!\n\x0c\n\x05\x04\x02\
    \x02\x06\x03\x12\x03N$(\n\x0b\n\x04\x04\x02\x02\x07\x12\x03O\x04#\n\x0c\
    \n\x05\x04\x02\x02\x07\x06\x12\x03O\x04\x14\n\x0c\n\x05\x04\x02\x02\x07\
    \x01\x12\x03O\x15\x1b\n\x0c\n\x05\x04\x02\x02\x07\x03\x12\x03O\x1e\"\n\
    \x0b\n\x04\x04\x02\x02\x08\x12\x03P\x04#\n\x0c\n\x05\x04\x02\x02\x08\x06\
    \x12\x03P\x04\x14\n\x0c\n\x05\x04\x02\x02\x08\x01\x12\x03P\x15\x1b\n\x0c\
    \n\x05\x04\x02\x02\x08\x03\x12\x03P\x1e\"\n\x0b\n\x04\x04\x02\x02\t\x12\
    \x03Q\x04#\n\x0c\n\x05\x04\x02\x02\t\x06\x12\x03Q\x04\x14\n\x0c\n\x05\
    \x04\x02\x02\t\x01\x12\x03Q\x15\x1b\n\x0c\n\x05\x04\x02\x02\t\x03\x12\
    \x03Q\x1e\"\n\x0b\n\x04\x04\x02\x02\n\x12\x03R\x04.\n\x0c\n\x05\x04\x02\
    \x02\n\x06\x12\x03R\x04\x19\n\x0c\n\x05\x04\x02\x02\n\x01\x12\x03R\x1a&\
    \n\x0c\n\x05\x04\x02\x02\n\x03\x12\x03R)-\n\x0b\n\x04\x04\x02\x02\x0b\
    \x12\x03S\x04\x1b\n\x0c\n\x05\x04\x02\x02\x0b\x06\x12\x03S\x04\x10\n\x0c\
    \n\x05\x04\x02\x02\x0b\x01\x12\x03S\x11\x13\n\x0c\n\x05\x04\x02\x02\x0b\
    \x03\x12\x03S\x16\x1a\n\x0b\n\x04\x04\x02\x02\x0c\x12\x03T\x04.\n\x0c\n\
    \x05\x04\x02\x02\x0c\x06\x12\x03T\x04\x19\n\x0c\n\x05\x04\x02\x02\x0c\
    \x01\x12\x03T\x1a&\n\x0c\n\x05\x04\x02\x02\x0c\x03\x12\x03T)-\n\x0b\n\
    \x04\x04\x02\x02\r\x12\x03U\x04*\n\x0c\n\x05\x04\x02\x02\r\x06\x12\x03U\
    \x04\x17\n\x0c\n\x05\x04\x02\x02\r\x01\x12\x03U\x18\"\n\x0c\n\x05\x04\
    \x02\x02\r\x03\x12\x03U%)\n\x0b\n\x04\x04\x02\x02\x0e\x12\x03V\x048\n\
    \x0c\n\x05\x04\x02\x02\x0e\x06\x12\x03V\x04\x1e\n\x0c\n\x05\x04\x02\x02\
    \x0e\x01\x12\x03V\x1f0\n\x0c\n\x05\x04\x02\x02\x0e\x03\x12\x03V37\n}\n\
    \x04\x04\x02\x02\x0f\x12\x03Z\x02#\x1a9\x20ID\x20is\x20a\x20uuid(sha256(\
    _wasm_bytes))\x20that\x20is\x20set\x20by\x20server\n\"5\x20protolint:dis\
    able:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\x02\x02\x0f\
    \x04\x12\x03Z\x02\n\n\x0c\n\x05\x04\x02\x02\x0f\x05\x12\x03Z\x0b\x11\n\
    \x0c\n\x05\x04\x02\x02\x0f\x01\x12\x03Z\x12\x1a\n\x0c\n\x05\x04\x02\x02\
    \x0f\x03\x12\x03Z\x1d\"\ng\n\x04\x04\x02\x02\x10\x12\x03]\x02%\x1a#\x20W\
    ASM\x20module\x20bytes\x20(set\x20by\x20server)\n\"5\x20protolint:disabl\
    e:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\x02\x02\x10\x04\
    \x12\x03]\x02\n\n\x0c\n\x05\x04\x02\x02\x10\x05\x12\x03]\x0b\x10\n\x0c\n\
    \x05\x04\x02\x02\x10\x01\x12\x03]\x11\x1c\n\x0c\n\x05\x04\x02\x02\x10\
    \x03\x12\x03]\x1f$\ns\n\x04\x04\x02\x02\x11\x12\x03`\x02)\x1a/\x20WASM\
    \x20function\x20name\x20to\x20execute\x20(set\x20by\x20server)\n\"5\x20p\
    rotolint:disable:this\x20FIELD_NAMES_LOWER_SNAKE_CASE\n\n\x0c\n\x05\x04\
    \x02\x02\x11\x04\x12\x03`\x02\n\n\x0c\n\x05\x04\x02\x02\x11\x05\x12\x03`\
    \x0b\x11\n\x0c\n\x05\x04\x02\x02\x11\x01\x12\x03`\x12\x20\n\x0c\n\x05\
    \x04\x02\x02\x11\x03\x12\x03`#(b\x06proto3\
";
