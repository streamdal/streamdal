...
impl ::protobuf::Message for NotifyRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.condition_type = is.read_string()?;
                },
                18 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.condition_type.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.condition_type);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if !self.condition_type.is_empty() {
            os.write_string(1, &self.condition_type)?;
        }
        if let Some(v) = self.step.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(2, v, os)?;
        }
    ...
    fn default_instance() -> &'static NotifyRequest {
        static instance: NotifyRequest = NotifyRequest {
            condition_type: ::std::string::String::new(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01(\tR\rconditionType\x12(\n\x04step\x18\x02\x20\x01(\x0b2\x14.protos.\
    PipelineStepR\x04step\x12,\n\x08audience\x18\x03\x20\x01(\x0b2\x10.proto\
    s.AudienceR\x08audience\x124\n\x17occurred_at_unix_ts_utc\x18\x04\x20\
    \x01(\x03R\x13occurredAtUnixTsUtc\x12\x1f\n\x0bpipeline_id\x18\x05\x20\
    \x01(\tR\npipelineId\x12\x18\n\x07payload\x18\x06\x20\x01(\x0cR\x07paylo\
    ad\":\n\x0eMetricsRequest\x12(\n\x07metrics\x18\x01\x20\x03(\x0b2\x0e.pr\
    otos.MetricR\x07metrics\"\xd1\x01\n\x0fRegisterRequest\x12!\n\x0cservice\
    _name\x18\x01\x20\x01(\tR\x0bserviceName\x12\x1d\n\nsession_id\x18\x02\
    \x20\x01(\tR\tsessionId\x123\n\x0bclient_info\x18\x03\x20\x01(\x0b2\x12.\
    protos.ClientInfoR\nclientInfo\x12.\n\taudiences\x18\x04\x20\x03(\x0b2\
    \x10.protos.AudienceR\taudiences\x12\x17\n\x07dry_run\x18\x05\x20\x01(\
    \x08R\x06dryRun\"U\n\x11DeregisterRequest\x12!\n\x0cservice_name\x18\x01\
    \x20\x01(\tR\x0bserviceName\x12\x1d\n\nsession_id\x18\x02\x20\x01(\tR\ts\
    essionId\"L\n'GetSetPipelinesCommandsByServiceRequest\x12!\n\x0cservice_\
    name\x18\x01\x20\x01(\tR\x0bserviceName\"\xa9\x02\n(GetSetPipelinesComma\
    ndsByServiceResponse\x12C\n\x15set_pipeline_commands\x18\x01\x20\x03(\
    \x0b2\x0f.protos.CommandR\x13setPipelineCommands\x12d\n\x0cwasm_modules\
    \x18\x03\x20\x03(\x0b2A.protos.GetSetPipelinesCommandsByServiceResponse.\
    WasmModulesEntryR\x0bwasmModules\x1aR\n\x10WasmModulesEntry\x12\x10\n\
    \x03key\x18\x01\x20\x01(\tR\x03key\x12(\n\x05value\x18\x02\x20\x01(\x0b2\
    \x12.protos.WasmModuleR\x05value:\x028\x01\"N\n\nWasmModule\x12\x0e\n\
    \x02id\x18\x01\x20\x01(\tR\x02id\x12\x14\n\x05bytes\x18\x02\x20\x01(\x0c\
    R\x05bytes\x12\x1a\n\x08function\x18\x03\x20\x01(\tR\x08function\"i\n\
    \x11SendSchemaRequest\x12,\n\x08audience\x18\x01\x20\x01(\x0b2\x10.proto\
    s.AudienceR\x08audience\x12&\n\x06schema\x18\x02\x20\x01(\x0b2\x0e.proto\
    s.SchemaR\x06schema2\xc9\x04\n\x08Internal\x126\n\x08Register\x12\x17.pr\
    ...
    os.StandardResponse\x12\x85\x01\n\x20GetSetPipelinesCommandsByService\
    \x12/.protos.GetSetPipelinesCommandsByServiceRequest\x1a0.protos.GetSetP\
    ipelinesCommandsByServiceResponse\x12<\n\x08SendTail\x12\x14.protos.Tail\
    Response\x1a\x18.protos.StandardResponse(\x01\x12A\n\nSendSchema\x12\x19\
    .protos.SendSchemaRequest\x1a\x18.protos.StandardResponseB<Z:github.com/\
    streamdal/streamdal/libs/protos/build/go/protosJ\xf9-\n\x07\x12\x05\0\0\
    ...
    \xbc\x02\n\x04\x06\0\x02\0\x12\x03\x11\x02@\x1a\xae\x02\x20Initial\x20me\
    thod\x20that\x20an\x20SDK\x20should\x20call\x20to\x20register\x20itself\
    \x20with\x20the\x20server.\n\x20The\x20server\x20will\x20use\x20this\x20\
    stream\x20to\x20send\x20commands\x20to\x20the\x20SDK\x20via\x20the\n\x20\
    `CommandResponse`\x20message.\x20Clients\x20should\x20continuously\x20li\
    sten\x20for\n\x20CommandResponse\x20messages\x20and\x20re-establish\x20r\
    egistration\x20if\x20the\x20stream\x20gets\n\x20disconnected.\n\n\x0c\n\
    \x05\x06\0\x02\0\x01\x12\x03\x11\x06\x0e\n\x0c\n\x05\x06\0\x02\0\x02\x12\
    \x03\x11\x0f\x1e\n\x0c\n\x05\x06\0\x02\0\x06\x12\x03\x11)/\n\x0c\n\x05\
    \x06\0\x02\0\x03\x12\x03\x110>\n\xb0\x01\n\x04\x06\0\x02\x01\x12\x03\x16\
    \x02A\x1a\xa2\x01\x20Declare\x20a\x20new\x20audience\x20that\x20the\x20S\
    DK\x20is\x20able\x20to\x20accept\x20commands\x20for.\n\x20An\x20SDK\x20w\
    ould\x20use\x20this\x20method\x20when\x20a\x20new\x20audience\x20is\x20d\
    eclared\x20by\x20the\x20user\n\x20via\x20`.Process()`.\n\n\x0c\n\x05\x06\
    \0\x02\x01\x01\x12\x03\x16\x06\x11\n\x0c\n\x05\x06\0\x02\x01\x02\x12\x03\
    \x16\x12$\n\x0c\n\x05\x06\0\x02\x01\x03\x12\x03\x16/?\n\x84\x01\n\x04\
    \x06\0\x02\x02\x12\x03\x1a\x02=\x1aw\x20SDK\x20is\x20responsible\x20for\
    ...
    \n\x0c\n\x05\x06\0\x02\x02\x01\x12\x03\x1a\x06\x0f\n\x0c\n\x05\x06\0\x02\
    \x02\x02\x12\x03\x1a\x10\x20\n\x0c\n\x05\x06\0\x02\x02\x03\x12\x03\x1a+;\
    \n\x86\x01\n\x04\x06\0\x02\x03\x12\x03\x1e\x027\x1ay\x20Use\x20this\x20m\
    ...
    \x20notification.\n\n\x0c\n\x05\x06\0\x02\x03\x01\x12\x03\x1e\x06\x0c\n\
    \x0c\n\x05\x06\0\x02\x03\x02\x12\x03\x1e\r\x1a\n\x0c\n\x05\x06\0\x02\x03\
    \x03\x12\x03\x1e%5\n2\n\x04\x06\0\x02\x04\x12\x03!\x029\x1a%\x20Send\x20\
    periodic\x20metrics\x20to\x20the\x20server\n\n\x0c\n\x05\x06\0\x02\x04\
    \x01\x12\x03!\x06\r\n\x0c\n\x05\x06\0\x02\x04\x02\x12\x03!\x0e\x1c\n\x0c\
    \n\x05\x06\0\x02\x04\x03\x12\x03!'7\n\x8b\x01\n\x04\x06\0\x02\x05\x12\
    \x04%\x02\x83\x01\x1a}\x20Used\x20to\x20pull\x20all\x20pipeline\x20confi\
    gs\x20for\x20the\x20service\x20name\x20in\x20the\x20SDK's\x20constructor\
    \n\x20This\x20is\x20needed\x20because\x20Register()\x20is\x20async\n\n\
    \x0c\n\x05\x06\0\x02\x05\x01\x12\x03%\x06&\n\x0c\n\x05\x06\0\x02\x05\x02\
    \x12\x03%'N\n\r\n\x05\x06\0\x02\x05\x03\x12\x04%Y\x81\x01\n\x0b\n\x04\
    ...
    \x04\x04\0\x02\x01\x12\x032\x02\x18\x1a\x19\x20Newly\x20created\x20audie\
    nce.\n\n\x0c\n\x05\x04\0\x02\x01\x06\x12\x032\x02\n\n\x0c\n\x05\x04\0\
    \x02\x01\x01\x12\x032\x0b\x13\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x032\x16\
    \x17\n\x8a\x01\n\x02\x04\x01\x12\x047\0D\x01\x1a~\x20Each\x20consumer\
    ...
    \n\x04\x04\x01\x02\0\x12\x039\x02\x18\x1a*\x20Session\x20ID\x20for\x20th\
    is\x20instance\x20of\x20the\x20SDK.\n\n\x0c\n\x05\x04\x01\x02\0\x05\x12\
    \x039\x02\x08\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x039\t\x13\n\x0c\n\x05\
    \x04\x01\x02\0\x03\x12\x039\x16\x17\nb\n\x04\x04\x01\x02\x01\x12\x03<\
    ...
    \x20!\n/\n\x04\x04\x01\x02\x03\x12\x03C\x02$\x1a\"\x20Used\x20for\x20ref\
    reshing\x20registration\n\n\x0c\n\x05\x04\x01\x02\x03\x06\x12\x03C\x02\
    \x13\n\x0c\n\x05\x04\x01\x02\x03\x01\x12\x03C\x14\x1f\n\x0c\n\x05\x04\
    \x01\x02\x03\x03\x12\x03C\"#\n\n\n\x02\x04\x02\x12\x04F\0[\x01\n\n\n\x03\
    \x04\x02\x01\x12\x03F\x08\x15\n\xa7\x02\n\x04\x04\x02\x02\0\x12\x03K\x02\
    \x1c\x1a\x83\x02\x20Included\x20in\x20notification\n\x20This\x20will\x20\
    be\x20used\x20to\x20pull\x20the\x20condition\x20type\x20(true,\x20false,\
    ...
    fication\x20configuration\x20also.\n\"\x14\x20true,\x20false,\x20error\n\
    \n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03K\x02\x08\n\x0c\n\x05\x04\x02\x02\
    \0\x01\x12\x03K\t\x17\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x03K\x1a\x1b\nQ\
    \n\x04\x04\x02\x02\x01\x12\x03N\x02\x18\x1aD\x20Used\x20for\x20pulling\
    \x20step\x20name\x20and\x20any\x20other\x20info\x20needed\x20in\x20the\
    \x20future\n\n\x0c\n\x05\x04\x02\x02\x01\x06\x12\x03N\x02\x0e\n\x0c\n\
    \x05\x04\x02\x02\x01\x01\x12\x03N\x0f\x13\n\x0c\n\x05\x04\x02\x02\x01\
    \x03\x12\x03N\x16\x17\n'\n\x04\x04\x02\x02\x02\x12\x03Q\x02\x18\x1a\x1a\
    \x20Included\x20in\x20notification\n\n\x0c\n\x05\x04\x02\x02\x02\x06\x12\
    \x03Q\x02\n\n\x0c\n\x05\x04\x02\x02\x02\x01\x12\x03Q\x0b\x13\n\x0c\n\x05\
    \x04\x02\x02\x02\x03\x12\x03Q\x16\x17\n'\n\x04\x04\x02\x02\x03\x12\x03T\
    \x02$\x1a\x1a\x20Included\x20in\x20notification\n\n\x0c\n\x05\x04\x02\
    \x02\x03\x05\x12\x03T\x02\x07\n\x0c\n\x05\x04\x02\x02\x03\x01\x12\x03T\
    \x08\x1f\n\x0c\n\x05\x04\x02\x02\x03\x03\x12\x03T\"#\n'\n\x04\x04\x02\
    \x02\x04\x12\x03W\x02\x19\x1a\x1a\x20Included\x20in\x20notification\n\n\
    \x0c\n\x05\x04\x02\x02\x04\x05\x12\x03W\x02\x08\n\x0c\n\x05\x04\x02\x02\
    \x04\x01\x12\x03W\t\x14\n\x0c\n\x05\x04\x02\x02\x04\x03\x12\x03W\x17\x18\
    \n'\n\x04\x04\x02\x02\x05\x12\x03Z\x02\x14\x1a\x1a\x20Included\x20in\x20\
    notification\n\n\x0c\n\x05\x04\x02\x02\x05\x05\x12\x03Z\x02\x07\n\x0c\n\
    \x05\x04\x02\x02\x05\x01\x12\x03Z\x08\x0f\n\x0c\n\x05\x04\x02\x02\x05\
    \x03\x12\x03Z\x12\x13\n\n\n\x02\x04\x03\x12\x04]\0_\x01\n\n\n\x03\x04\
    \x03\x01\x12\x03]\x08\x16\n\x0b\n\x04\x04\x03\x02\0\x12\x03^\x02%\n\x0c\
    \n\x05\x04\x03\x02\0\x04\x12\x03^\x02\n\n\x0c\n\x05\x04\x03\x02\0\x06\
    \x12\x03^\x0b\x18\n\x0c\n\x05\x04\x03\x02\0\x01\x12\x03^\x19\x20\n\x0c\n\
    \x05\x04\x03\x02\0\x03\x12\x03^#$\n\n\n\x02\x04\x04\x12\x04a\0v\x01\n\n\
    \n\x03\x04\x04\x01\x12\x03a\x08\x17\nC\n\x04\x04\x04\x02\0\x12\x03c\x02\
    \x1a\x1a6\x20REQUIRED\x20--\x20Name\x20of\x20the\x20service\x20that\x20i\
    s\x20registering.\n\n\x0c\n\x05\x04\x04\x02\0\x05\x12\x03c\x02\x08\n\x0c\
    \n\x05\x04\x04\x02\0\x01\x12\x03c\t\x15\n\x0c\n\x05\x04\x04\x02\0\x03\
    \x12\x03c\x18\x19\n\xad\x01\n\x04\x04\x04\x02\x01\x12\x03i\x02\x18\x1a\
    \x9f\x01\x20REQUIRED\x20--\x20Unique\x20ID\x20for\x20this\x20SDK\x20inst\
    ance.\n\n\x20This\x20should\x20be\x20generated\x20every\x20time\x20the\
    \x20SDK\x20is\x20instantiated\x20(oe.\x20every\n\x20time\x20a\x20NEW\x20\
    registration\x20is\x20performed).\n\n\x0c\n\x05\x04\x04\x02\x01\x05\x12\
    \x03i\x02\x08\n\x0c\n\x05\x04\x04\x02\x01\x01\x12\x03i\t\x13\n\x0c\n\x05\
    \x04\x04\x02\x01\x03\x12\x03i\x16\x17\nQ\n\x04\x04\x04\x02\x02\x12\x03l\
    \x02$\x1aD\x20REQUIRED\x20--\x20Info\x20about\x20the\x20client\x20(lib\
    \x20name,\x20lang,\x20os,\x20arch,\x20etc.)\n\n\x0c\n\x05\x04\x04\x02\
    \x02\x06\x12\x03l\x02\x13\n\x0c\n\x05\x04\x04\x02\x02\x01\x12\x03l\x14\
    \x1f\n\x0c\n\x05\x04\x04\x02\x02\x03\x12\x03l\"#\n\x87\x01\n\x04\x04\x04\
    \x02\x03\x12\x03p\x02)\x1az\x20OPTIONAL\x20--\x20if\x20these\x20are\x20d\
    ...
    \x04\x04\x02\x03\x06\x12\x03p\x0b\x1a\n\x0c\n\x05\x04\x04\x02\x03\x01\
    \x12\x03p\x1b$\n\x0c\n\x05\x04\x04\x02\x03\x03\x12\x03p'(\n\xd9\x01\n\
    \x04\x04\x04\x02\x04\x12\x03u\x02\x13\x1a\xcb\x01\x20OPTIONAL\x20--\x20I\
    ...
    \x20set.\n\n\x0c\n\x05\x04\x04\x02\x04\x05\x12\x03u\x02\x06\n\x0c\n\x05\
    \x04\x04\x02\x04\x01\x12\x03u\x07\x0e\n\x0c\n\x05\x04\x04\x02\x04\x03\
    \x12\x03u\x11\x12\nT\n\x02\x04\x05\x12\x04y\0|\x01\x1aH\x20Same\x20as\
    \x20RegisterRequest\x20-\x20used\x20for\x20broadcasting\x20a\x20deregist\
    ration\x20event\n\n\n\n\x03\x04\x05\x01\x12\x03y\x08\x19\n\x0b\n\x04\x04\
    \x05\x02\0\x12\x03z\x02\x1a\n\x0c\n\x05\x04\x05\x02\0\x05\x12\x03z\x02\
    \x08\n\x0c\n\x05\x04\x05\x02\0\x01\x12\x03z\t\x15\n\x0c\n\x05\x04\x05\
    \x02\0\x03\x12\x03z\x18\x19\n\x0b\n\x04\x04\x05\x02\x01\x12\x03{\x02\x18\
    \n\x0c\n\x05\x04\x05\x02\x01\x05\x12\x03{\x02\x08\n\x0c\n\x05\x04\x05\
    \x02\x01\x01\x12\x03{\t\x13\n\x0c\n\x05\x04\x05\x02\x01\x03\x12\x03{\x16\
    \x17\n\xa6\x03\n\x02\x04\x06\x12\x06\x84\x01\0\x86\x01\x01\x1a\x97\x03\
    \x20Method\x20used\x20by\x20SDKs\x20to\x20fetch\x20all\x20SetPipelinesCo\
    mmands\x20for\x20a\x20given\x20service\x20name.\n\x20The\x20SDK\x20may\
    \x20not\x20know\x20of\x20all\x20audiences\x20yet\x20so\x20this\x20method\
    \x20returns\x20ALL\n\x20SetPipelinesCommands\x20that\x20use\x20the\x20sa\
    me\x20same\x20service\x20name.\x20SDKs\x20should\x20store\n\x20the\x20co\
    mmands\x20(or\x20pipelines)\x20in\x20memory\x20tied\x20to\x20an\x20audie\
    nce,\x20so\x20that\x20if/when\x20a\n\x20.Process()\x20call\x20occurs\x20\
    with\x20an\x20audience\x20-\x20the\x20SDK\x20will\x20already\x20have\x20\
    the\n\x20pipeline\x20config\x20in\x20memory.\n\n\x0b\n\x03\x04\x06\x01\
    \x12\x04\x84\x01\x08/\n\x0c\n\x04\x04\x06\x02\0\x12\x04\x85\x01\x02\x1a\
    \n\r\n\x05\x04\x06\x02\0\x05\x12\x04\x85\x01\x02\x08\n\r\n\x05\x04\x06\
    \x02\0\x01\x12\x04\x85\x01\t\x15\n\r\n\x05\x04\x06\x02\0\x03\x12\x04\x85\
    \x01\x18\x19\n\x0c\n\x02\x04\x07\x12\x06\x88\x01\0\x8e\x01\x01\n\x0b\n\
    \x03\x04\x07\x01\x12\x04\x88\x01\x080\n=\n\x04\x04\x07\x02\0\x12\x04\x8a\
    \x01\x024\x1a/\x20SetPipelinesCommands\x20for\x20all\x20active\x20pipeli\
    nes\n\n\r\n\x05\x04\x07\x02\0\x04\x12\x04\x8a\x01\x02\n\n\r\n\x05\x04\
    \x07\x02\0\x06\x12\x04\x8a\x01\x0b\x19\n\r\n\x05\x04\x07\x02\0\x01\x12\
    \x04\x8a\x01\x1a/\n\r\n\x05\x04\x07\x02\0\x03\x12\x04\x8a\x0123\n\x1c\n\
    \x04\x04\x07\x02\x01\x12\x04\x8d\x01\x02*\x1a\x0e\x20ID\x20=\x20wasm\x20\
    ID\n\n\r\n\x05\x04\x07\x02\x01\x06\x12\x04\x8d\x01\x02\x18\n\r\n\x05\x04\
    \x07\x02\x01\x01\x12\x04\x8d\x01\x19%\n\r\n\x05\x04\x07\x02\x01\x03\x12\
    \x04\x8d\x01()\n\xc8\x01\n\x02\x04\x08\x12\x06\x93\x01\0\x9c\x01\x01\x1a\
    ...
    \n\n\x0b\n\x03\x04\x08\x01\x12\x04\x93\x01\x08\x12\nQ\n\x04\x04\x08\x02\
    \0\x12\x04\x95\x01\x02\x10\x1aC\x20ID\x20is\x20a\x20uuid(sha256(_wasm_by\
    tes))\x20that\x20is\x20set\x20by\x20streamdal\x20server\n\n\r\n\x05\x04\
    \x08\x02\0\x05\x12\x04\x95\x01\x02\x08\n\r\n\x05\x04\x08\x02\0\x01\x12\
    \x04\x95\x01\t\x0b\n\r\n\x05\x04\x08\x02\0\x03\x12\x04\x95\x01\x0e\x0f\n\
    1\n\x04\x04\x08\x02\x01\x12\x04\x98\x01\x02\x12\x1a#\x20WASM\x20module\
    \x20bytes\x20(set\x20by\x20server)\n\n\r\n\x05\x04\x08\x02\x01\x05\x12\
    \x04\x98\x01\x02\x07\n\r\n\x05\x04\x08\x02\x01\x01\x12\x04\x98\x01\x08\r\
    \n\r\n\x05\x04\x08\x02\x01\x03\x12\x04\x98\x01\x10\x11\n=\n\x04\x04\x08\
    \x02\x02\x12\x04\x9b\x01\x02\x16\x1a/\x20WASM\x20function\x20name\x20to\
    \x20execute\x20(set\x20by\x20server)\n\n\r\n\x05\x04\x08\x02\x02\x05\x12\
    \x04\x9b\x01\x02\x08\n\r\n\x05\x04\x08\x02\x02\x01\x12\x04\x9b\x01\t\x11\
    \n\r\n\x05\x04\x08\x02\x02\x03\x12\x04\x9b\x01\x14\x15\n\x0c\n\x02\x04\t\
    \x12\x06\x9e\x01\0\xa1\x01\x01\n\x0b\n\x03\x04\t\x01\x12\x04\x9e\x01\x08\
    \x19\n\x0c\n\x04\x04\t\x02\0\x12\x04\x9f\x01\x02\x18\n\r\n\x05\x04\t\x02\
    \0\x06\x12\x04\x9f\x01\x02\n\n\r\n\x05\x04\t\x02\0\x01\x12\x04\x9f\x01\
    \x0b\x13\n\r\n\x05\x04\t\x02\0\x03\x12\x04\x9f\x01\x16\x17\n\x0c\n\x04\
    \x04\t\x02\x01\x12\x04\xa0\x01\x02\x14\n\r\n\x05\x04\t\x02\x01\x06\x12\
    \x04\xa0\x01\x02\x08\n\r\n\x05\x04\t\x02\x01\x01\x12\x04\xa0\x01\t\x0f\n\
    \r\n\x05\x04\t\x02\x01\x03\x12\x04\xa0\x01\x12\x13b\x06proto3\
";
