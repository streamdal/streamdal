...
pub struct GetAttachCommandsByServiceResponse {
    ...
    pub active: ::std::vec::Vec<super::sp_pipeline::Pipeline>,
    ...
    pub paused: ::std::vec::Vec<super::sp_pipeline::Pipeline>,
    ///  ID = wasm ID
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    e\x12,\n\x08audience\x18\x03\x20\x01(\x0b2\x10.protos.AudienceR\x08audie\
    nce\x124\n\x17occurred_at_unix_ts_utc\x18\x04\x20\x01(\x03R\x13occurredA\
    tUnixTsUtc\":\n\x0eMetricsRequest\x12(\n\x07metrics\x18\x01\x20\x03(\x0b\
    2\x0e.protos.MetricR\x07metrics\"\xd1\x01\n\x0fRegisterRequest\x12!\n\
    ...
    vice_name\x18\x01\x20\x01(\tR\x0bserviceName\"\xac\x02\n\"GetAttachComma\
    ndsByServiceResponse\x12(\n\x06active\x18\x01\x20\x03(\x0b2\x10.protos.P\
    ipelineR\x06active\x12(\n\x06paused\x18\x02\x20\x03(\x0b2\x10.protos.Pip\
    elineR\x06paused\x12^\n\x0cwasm_modules\x18\x03\x20\x03(\x0b2;.protos.Ge\
    tAttachCommandsByServiceResponse.WasmModulesEntryR\x0bwasmModules\x1aR\n\
    \x10WasmModulesEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12(\n\
    \x05value\x18\x02\x20\x01(\x0b2\x12.protos.WasmModuleR\x05value:\x028\
    \x01\"N\n\nWasmModule\x12\x0e\n\x02id\x18\x01\x20\x01(\tR\x02id\x12\x14\
    \n\x05bytes\x18\x02\x20\x01(\x0cR\x05bytes\x12\x1a\n\x08function\x18\x03\
    \x20\x01(\tR\x08function\"i\n\x11SendSchemaRequest\x12,\n\x08audience\
    \x18\x01\x20\x01(\x0b2\x10.protos.AudienceR\x08audience\x12&\n\x06schema\
    \x18\x02\x20\x01(\x0b2\x0e.protos.SchemaR\x06schema2\xb6\x04\n\x08Intern\
    al\x126\n\x08Register\x12\x17.protos.RegisterRequest\x1a\x0f.protos.Comm\
    and0\x01\x12C\n\x0bNewAudience\x12\x1a.protos.NewAudienceRequest\x1a\x18\
    .protos.StandardResponse\x12?\n\tHeartbeat\x12\x18.protos.HeartbeatReque\
    st\x1a\x18.protos.StandardResponse\x129\n\x06Notify\x12\x15.protos.Notif\
    yRequest\x1a\x18.protos.StandardResponse\x12;\n\x07Metrics\x12\x16.proto\
    s.MetricsRequest\x1a\x18.protos.StandardResponse\x12s\n\x1aGetAttachComm\
    andsByService\x12).protos.GetAttachCommandsByServiceRequest\x1a*.protos.\
    GetAttachCommandsByServiceResponse\x12<\n\x08SendTail\x12\x14.protos.Tai\
    lResponse\x1a\x18.protos.StandardResponse(\x01\x12A\n\nSendSchema\x12\
    \x19.protos.SendSchemaRequest\x1a\x18.protos.StandardResponseB<Z:github.\
    com/streamdal/streamdal/libs/protos/build/go/protosJ\xad'\n\x07\x12\x05\
    ...
    \x10\n\xbc\x02\n\x04\x06\0\x02\0\x12\x03\x11\x02@\x1a\xae\x02\x20Initial\
    ...
    \x02\x12\x03\x11\x0f\x1e\n\x0c\n\x05\x06\0\x02\0\x06\x12\x03\x11)/\n\x0c\
    \n\x05\x06\0\x02\0\x03\x12\x03\x110>\n\xb0\x01\n\x04\x06\0\x02\x01\x12\
    \x03\x16\x02A\x1a\xa2\x01\x20Declare\x20a\x20new\x20audience\x20that\x20\
    ...
    \x01\x02\x12\x03\x16\x12$\n\x0c\n\x05\x06\0\x02\x01\x03\x12\x03\x16/?\n\
    \x84\x01\n\x04\x06\0\x02\x02\x12\x03\x1a\x02=\x1aw\x20SDK\x20is\x20respo\
    ...
    \x12\x03\x1a+;\n\x86\x01\n\x04\x06\0\x02\x03\x12\x03\x1e\x027\x1ay\x20Us\
    ...
    \x06\0\x02\x05\x12\x03%\x02q\x1a}\x20Used\x20to\x20pull\x20all\x20pipeli\
    ne\x20configs\x20for\x20the\x20service\x20name\x20in\x20the\x20SDK's\x20\
    constructor\n\x20This\x20is\x20needed\x20because\x20Register()\x20is\x20\
    async\n\n\x0c\n\x05\x06\0\x02\x05\x01\x12\x03%\x06\x20\n\x0c\n\x05\x06\0\
    \x02\x05\x02\x12\x03%!B\n\x0c\n\x05\x06\0\x02\x05\x03\x12\x03%Mo\n\x0b\n\
    ...
    =\n\x04\x06\0\x02\x07\x12\x03*\x02?\x1a0\x20Used\x20by\x20SDK\x20to\x20s\
    end\x20a\x20new\x20schema\x20to\x20the\x20server\n\n\x0c\n\x05\x06\0\x02\
    ...
    \x01\x02\x03\x03\x12\x03C\"#\n\n\n\x02\x04\x02\x12\x04F\0K\x01\n\n\n\x03\
    \x04\x02\x01\x12\x03F\x08\x15\n\x0b\n\x04\x04\x02\x02\0\x12\x03G\x02\x19\
    \n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03G\x02\x08\n\x0c\n\x05\x04\x02\x02\
    \0\x01\x12\x03G\t\x14\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x03G\x17\x18\n\
    \x0b\n\x04\x04\x02\x02\x01\x12\x03H\x02\x17\n\x0c\n\x05\x04\x02\x02\x01\
    \x05\x12\x03H\x02\x08\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x03H\t\x12\n\
    \x0c\n\x05\x04\x02\x02\x01\x03\x12\x03H\x15\x16\n\x0b\n\x04\x04\x02\x02\
    \x02\x12\x03I\x02\x18\n\x0c\n\x05\x04\x02\x02\x02\x06\x12\x03I\x02\n\n\
    \x0c\n\x05\x04\x02\x02\x02\x01\x12\x03I\x0b\x13\n\x0c\n\x05\x04\x02\x02\
    \x02\x03\x12\x03I\x16\x17\n\x0b\n\x04\x04\x02\x02\x03\x12\x03J\x02$\n\
    \x0c\n\x05\x04\x02\x02\x03\x05\x12\x03J\x02\x07\n\x0c\n\x05\x04\x02\x02\
    \x03\x01\x12\x03J\x08\x1f\n\x0c\n\x05\x04\x02\x02\x03\x03\x12\x03J\"#\n\
    \n\n\x02\x04\x03\x12\x04M\0O\x01\n\n\n\x03\x04\x03\x01\x12\x03M\x08\x16\
    \n\x0b\n\x04\x04\x03\x02\0\x12\x03N\x02%\n\x0c\n\x05\x04\x03\x02\0\x04\
    \x12\x03N\x02\n\n\x0c\n\x05\x04\x03\x02\0\x06\x12\x03N\x0b\x18\n\x0c\n\
    \x05\x04\x03\x02\0\x01\x12\x03N\x19\x20\n\x0c\n\x05\x04\x03\x02\0\x03\
    \x12\x03N#$\n\n\n\x02\x04\x04\x12\x04Q\0f\x01\n\n\n\x03\x04\x04\x01\x12\
    \x03Q\x08\x17\nC\n\x04\x04\x04\x02\0\x12\x03S\x02\x1a\x1a6\x20REQUIRED\
    \x20--\x20Name\x20of\x20the\x20service\x20that\x20is\x20registering.\n\n\
    \x0c\n\x05\x04\x04\x02\0\x05\x12\x03S\x02\x08\n\x0c\n\x05\x04\x04\x02\0\
    \x01\x12\x03S\t\x15\n\x0c\n\x05\x04\x04\x02\0\x03\x12\x03S\x18\x19\n\xad\
    \x01\n\x04\x04\x04\x02\x01\x12\x03Y\x02\x18\x1a\x9f\x01\x20REQUIRED\x20-\
    ...
    rmed).\n\n\x0c\n\x05\x04\x04\x02\x01\x05\x12\x03Y\x02\x08\n\x0c\n\x05\
    \x04\x04\x02\x01\x01\x12\x03Y\t\x13\n\x0c\n\x05\x04\x04\x02\x01\x03\x12\
    ...
    \x1az\x20OPTIONAL\x20--\x20if\x20these\x20are\x20defined,\x20these\x20wi\
    ll\x20show\x20up\x20in\x20the\x20UI\x20even\x20if\n\x20there\x20is\x20no\
    \x20active\x20.Process()\x20call\x20from\x20the\x20SDK.\n\n\x0c\n\x05\
    \x04\x04\x02\x03\x04\x12\x03`\x02\n\n\x0c\n\x05\x04\x04\x02\x03\x06\x12\
    \x03`\x0b\x1a\n\x0c\n\x05\x04\x04\x02\x03\x01\x12\x03`\x1b$\n\x0c\n\x05\
    \x04\x04\x02\x03\x03\x12\x03`'(\n\xd9\x01\n\x04\x04\x04\x02\x04\x12\x03e\
    ...
    \x04\x04\x02\x04\x05\x12\x03e\x02\x06\n\x0c\n\x05\x04\x04\x02\x04\x01\
    \x12\x03e\x07\x0e\n\x0c\n\x05\x04\x04\x02\x04\x03\x12\x03e\x11\x12\nT\n\
    \x02\x04\x05\x12\x04i\0l\x01\x1aH\x20Same\x20as\x20RegisterRequest\x20-\
    ...
    \x1a\n\x0c\n\x05\x04\x05\x02\0\x05\x12\x03j\x02\x08\n\x0c\n\x05\x04\x05\
    \x02\0\x01\x12\x03j\t\x15\n\x0c\n\x05\x04\x05\x02\0\x03\x12\x03j\x18\x19\
    ...
    \x04n\0p\x01\n\n\n\x03\x04\x06\x01\x12\x03n\x08)\n\x0b\n\x04\x04\x06\x02\
    \0\x12\x03o\x02\x1a\n\x0c\n\x05\x04\x06\x02\0\x05\x12\x03o\x02\x08\n\x0c\
    \n\x05\x04\x06\x02\0\x01\x12\x03o\t\x15\n\x0c\n\x05\x04\x06\x02\0\x03\
    \x12\x03o\x18\x19\n\n\n\x02\x04\x07\x12\x04r\0|\x01\n\n\n\x03\x04\x07\
    \x01\x12\x03r\x08*\n6\n\x04\x04\x07\x02\0\x12\x03t\x02&\x1a)\x20AttachCo\
    mmands\x20for\x20all\x20active\x20pipelines\n\n\x0c\n\x05\x04\x07\x02\0\
    \x04\x12\x03t\x02\n\n\x0c\n\x05\x04\x07\x02\0\x06\x12\x03t\x0b\x1a\n\x0c\
    \n\x05\x04\x07\x02\0\x01\x12\x03t\x1b!\n\x0c\n\x05\x04\x07\x02\0\x03\x12\
    \x03t$%\nq\n\x04\x04\x07\x02\x01\x12\x03x\x02&\x1ad\x20AttachCommands,\
    \x20but\x20ones\x20which\x20are\x20paused\n\x20The\x20SDK\x20still\x20ne\
    eds\x20to\x20have\x20these\x20to\x20support\x20un-pausing\n\n\x0c\n\x05\
    \x04\x07\x02\x01\x04\x12\x03x\x02\n\n\x0c\n\x05\x04\x07\x02\x01\x06\x12\
    \x03x\x0b\x1a\n\x0c\n\x05\x04\x07\x02\x01\x01\x12\x03x\x1b!\n\x0c\n\x05\
    \x04\x07\x02\x01\x03\x12\x03x$%\n\x1b\n\x04\x04\x07\x02\x02\x12\x03{\x02\
    *\x1a\x0e\x20ID\x20=\x20wasm\x20ID\n\n\x0c\n\x05\x04\x07\x02\x02\x06\x12\
    \x03{\x02\x18\n\x0c\n\x05\x04\x07\x02\x02\x01\x12\x03{\x19%\n\x0c\n\x05\
    \x04\x07\x02\x02\x03\x12\x03{()\n\xc8\x01\n\x02\x04\x08\x12\x06\x81\x01\
    \0\x8a\x01\x01\x1a\xb9\x01\x20WasmModule\x20is\x20used\x20to\x20ensure\
    \x20we\x20only\x20send\x20the\x20wasm\x20module\x20once\x20per\x20reques\
    ...
    \x12\nQ\n\x04\x04\x08\x02\0\x12\x04\x83\x01\x02\x10\x1aC\x20ID\x20is\x20\
    a\x20uuid(sha256(_wasm_bytes))\x20that\x20is\x20set\x20by\x20streamdal\
    \x20server\n\n\r\n\x05\x04\x08\x02\0\x05\x12\x04\x83\x01\x02\x08\n\r\n\
    \x05\x04\x08\x02\0\x01\x12\x04\x83\x01\t\x0b\n\r\n\x05\x04\x08\x02\0\x03\
    \x12\x04\x83\x01\x0e\x0f\n1\n\x04\x04\x08\x02\x01\x12\x04\x86\x01\x02\
    \x12\x1a#\x20WASM\x20module\x20bytes\x20(set\x20by\x20server)\n\n\r\n\
    \x05\x04\x08\x02\x01\x05\x12\x04\x86\x01\x02\x07\n\r\n\x05\x04\x08\x02\
    \x01\x01\x12\x04\x86\x01\x08\r\n\r\n\x05\x04\x08\x02\x01\x03\x12\x04\x86\
    \x01\x10\x11\n=\n\x04\x04\x08\x02\x02\x12\x04\x89\x01\x02\x16\x1a/\x20WA\
    SM\x20function\x20name\x20to\x20execute\x20(set\x20by\x20server)\n\n\r\n\
    \x05\x04\x08\x02\x02\x05\x12\x04\x89\x01\x02\x08\n\r\n\x05\x04\x08\x02\
    \x02\x01\x12\x04\x89\x01\t\x11\n\r\n\x05\x04\x08\x02\x02\x03\x12\x04\x89\
    \x01\x14\x15\n\x0c\n\x02\x04\t\x12\x06\x8c\x01\0\x8f\x01\x01\n\x0b\n\x03\
    \x04\t\x01\x12\x04\x8c\x01\x08\x19\n\x0c\n\x04\x04\t\x02\0\x12\x04\x8d\
    \x01\x02\x18\n\r\n\x05\x04\t\x02\0\x06\x12\x04\x8d\x01\x02\n\n\r\n\x05\
    \x04\t\x02\0\x01\x12\x04\x8d\x01\x0b\x13\n\r\n\x05\x04\t\x02\0\x03\x12\
    \x04\x8d\x01\x16\x17\n\x0c\n\x04\x04\t\x02\x01\x12\x04\x8e\x01\x02\x14\n\
    \r\n\x05\x04\t\x02\x01\x06\x12\x04\x8e\x01\x02\x08\n\r\n\x05\x04\t\x02\
