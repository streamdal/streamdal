...
class BusEvent(_message.Message):
    __slots__ = ["_metadata", "create_pipeline_request", "delete_audience_request", "delete_pipeline_request", "deregister_request", "kv_request", "metrics_request", "new_audience_request", "pause_pipeline_request", "register_request", "resume_pipeline_request", "set_pipelines_request", "source", "tail_request", "tail_response", "update_pipeline_request"]
    ...
    SET_PIPELINES_REQUEST_FIELD_NUMBER: _ClassVar[int]
    ...
    set_pipelines_request: _sp_external_pb2.SetPipelinesRequest
    source: str
