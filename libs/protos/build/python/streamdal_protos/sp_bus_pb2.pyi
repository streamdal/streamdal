...
class BusEvent(_message.Message):
    __slots__ = ["_metadata", "attach_pipeline_request", "create_pipeline_request", "delete_audience_request", "delete_pipeline_request", "deregister_request", "detach_pipeline_request", "kv_request", "metrics_request", "new_audience_request", "pause_pipeline_request", "register_request", "resume_pipeline_request", "set_pipelines_request", "source", "tail_request", "tail_response", "update_pipeline_request"]
