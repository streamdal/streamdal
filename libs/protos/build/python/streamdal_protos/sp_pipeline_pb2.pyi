...
PIPELINE_STEP_CONDITION_DISCARD_MESSAGE: PipelineStepCondition
...
class PipelineStep(_message.Message):
    __slots__ = ["_wasm_bytes", "_wasm_function", "_wasm_id", "custom", "decode", "detective", "dynamic", "encode", "http_request", "infer_schema", "kv", "name", "on_failure", "on_success", "schema_validation", "transform", "valid_json"]
