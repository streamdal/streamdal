...
class WASMRequest(_message.Message):
    __slots__ = ["input_payload", "input_step", "step"]
    ...
    def __init__(self, step: _Optional[_Union[_sp_pipeline_pb2.PipelineStep, _Mapping]] = ..., input_payload: _Optional[bytes] = ..., input_step: _Optional[bytes] = ...) -> None: ...
