...
class Wasm(_message.Message):
    __slots__ = ["_bundled", "_created_at_unix_ts_ns_utc", "_updated_at_unix_ts_ns_utc", "bytes", "description", "function_name", "id", "name", "url", "version"]
    ...
    url: str
    version: str
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., bytes: _Optional[bytes] = ..., function_name: _Optional[str] = ..., _bundled: bool = ..., description: _Optional[str] = ..., version: _Optional[str] = ..., url: _Optional[str] = ..., _created_at_unix_ts_ns_utc: _Optional[int] = ..., _updated_at_unix_ts_ns_utc: _Optional[int] = ...) -> None: ...
