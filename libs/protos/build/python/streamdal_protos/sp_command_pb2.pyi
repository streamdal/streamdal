...
class Command(_message.Message):
    __slots__ = ["attach_pipeline", "audience", "detach_pipeline", "keep_alive", "kv", "pause_pipeline", "pipeline_list", "resume_pipeline", "tail"]
