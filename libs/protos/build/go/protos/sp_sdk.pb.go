...
const (
	...
	ShimErrorMode_SHIM_ERROR_MODE_UNSET ShimErrorMode = 0
	...
	ShimErrorMode_SHIM_ERROR_MODE_STRICT ShimErrorMode = 1
)

// Enum value maps for ShimErrorMode.
var (
	ShimErrorMode_name = map[int32]string{
		0: "SHIM_ERROR_MODE_UNSET",
		1: "SHIM_ERROR_MODE_STRICT",
	}
	ShimErrorMode_value = map[string]int32{
		"SHIM_ERROR_MODE_UNSET":  0,
		"SHIM_ERROR_MODE_STRICT": 1,
	}
)

func (x ShimErrorMode) Enum() *ShimErrorMode {
	p := new(ShimErrorMode)
	*p = x
	return p
}

func (x ShimErrorMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ShimErrorMode) Descriptor() protoreflect.EnumDescriptor {
	return file_sp_sdk_proto_enumTypes[1].Descriptor()
}

func (ShimErrorMode) Type() protoreflect.EnumType {
	return &file_sp_sdk_proto_enumTypes[1]
}

func (x ShimErrorMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ShimErrorMode.Descriptor instead.
func (ShimErrorMode) EnumDescriptor() ([]byte, []int) {
...
type SDKStartupConfig struct {
	...
	ShimRequireRuntimeConfig *bool `protobuf:"varint,1000,opt,name=shim_require_runtime_config,json=shimRequireRuntimeConfig,proto3,oneof" json:"shim_require_runtime_config,omitempty"`
	// Tells the SDK how to behave when it runs into an error
	ShimErrorMode *ShimErrorMode `protobuf:"varint,1001,opt,name=shim_error_mode,json=shimErrorMode,proto3,enum=protos.ShimErrorMode,oneof" json:"shim_error_mode,omitempty"`
}
...
func (x *SDKStartupConfig) GetShimRequireRuntimeConfig() bool {
	if x != nil && x.ShimRequireRuntimeConfig != nil {
		return *x.ShimRequireRuntimeConfig
	}
	return false
}

func (x *SDKStartupConfig) GetShimErrorMode() ShimErrorMode {
	if x != nil && x.ShimErrorMode != nil {
		return *x.ShimErrorMode
	}
	return ShimErrorMode_SHIM_ERROR_MODE_UNSET
}
...
type ShimRuntimeConfig struct {
	...
	ErrorMode *ShimErrorMode `protobuf:"varint,1,opt,name=error_mode,json=errorMode,proto3,enum=protos.ShimErrorMode,oneof" json:"error_mode,omitempty"`
...
func (x *ShimRuntimeConfig) Reset() {
	*x = ShimRuntimeConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *ShimRuntimeConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShimRuntimeConfig) ProtoMessage() {}

func (x *ShimRuntimeConfig) ProtoReflect() protoreflect.Message {
	mi := &file_sp_sdk_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShimRuntimeConfig.ProtoReflect.Descriptor instead.
func (*ShimRuntimeConfig) Descriptor() ([]byte, []int) {
	return file_sp_sdk_proto_rawDescGZIP(), []int{4}
}

func (x *ShimRuntimeConfig) GetErrorMode() ShimErrorMode {
...
func (x *ShimRuntimeConfig) GetAudience() *Audience {
	if x != nil {
		return x.Audience
	}
	return nil
...
var file_sp_sdk_proto_rawDesc = []byte{
	...
	0x22, 0xf1, 0x03, 0x0a, 0x10, 0x53, 0x44, 0x4b, 0x53, 0x74, 0x61, 0x72, 0x74, 0x75, 0x70, 0x43,
	...
	,
...
var file_sp_sdk_proto_goTypes = []interface{}{
	...
	(ShimErrorMode)(0),        // 1: protos.ShimErrorMode
	...
	(*ShimRuntimeConfig)(nil), // 6: protos.ShimRuntimeConfig
...
var file_sp_sdk_proto_depIdxs = []int32{
	...
	1, // 6: protos.SDKStartupConfig.shim_error_mode:type_name -> protos.ShimErrorMode
	1, // 7: protos.ShimRuntimeConfig.error_mode:type_name -> protos.ShimErrorMode
	9, // 8: protos.ShimRuntimeConfig.audience:type_name -> protos.Audience
...
func file_sp_sdk_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sp_sdk_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShimRuntimeConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
