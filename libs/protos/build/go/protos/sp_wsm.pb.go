...
type CustomWasm struct {
	...
	WasmBytes string `protobuf:"bytes,3,opt,name=wasm_bytes,json=wasmBytes,proto3" json:"wasm_bytes,omitempty"`
	// Informative/debug fields
	Description *string `protobuf:"bytes,100,opt,name=description,proto3,oneof" json:"description,omitempty"`
	Version     *string `protobuf:"bytes,101,opt,name=version,proto3,oneof" json:"version,omitempty"`
	Url         *string `protobuf:"bytes,102,opt,name=url,proto3,oneof" json:"url,omitempty"`
...
func (x *CustomWasm) Reset() {
	*x = CustomWasm{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sp_wsm_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CustomWasm) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomWasm) ProtoMessage() {}

func (x *CustomWasm) ProtoReflect() protoreflect.Message {
	mi := &file_sp_wsm_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomWasm.ProtoReflect.Descriptor instead.
func (*CustomWasm) Descriptor() ([]byte, []int) {
	return file_sp_wsm_proto_rawDescGZIP(), []int{3}
}

func (x *CustomWasm) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CustomWasm) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CustomWasm) GetWasmBytes() string {
	if x != nil {
		return x.WasmBytes
	}
	return ""
...
func (x *CustomWasm) GetDescription() string {
...
func (x *CustomWasm) GetVersion() string {
...
func (x *CustomWasm) GetUrl() string {
	if x != nil && x.Url != nil {
		return *x.Url
	}
	return ""
...
func (x *CustomWasm) GetXCreatedAtUnixTsNsUtc() int64 {
...
func (x *CustomWasm) GetXUpdatedAtUnixTsNsUtc() int64 {
...
var file_sp_wsm_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x73, 0x5f, 0x6e, 0x73, 0x5f, 0x75, 0x74, 0x63, 0x2a, 0x75, 0x0a, 0x0c, 0x57, 0x41, 0x53,
...
var file_sp_wsm_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_sp_wsm_proto_goTypes = []interface{}{
	...
	(*CustomWasm)(nil),                // 4: protos.CustomWasm
	(*PipelineStep)(nil),              // 5: protos.PipelineStep
	(*steps.DetectiveStepResult)(nil), // 6: protos.steps.DetectiveStepResult
}
var file_sp_wsm_proto_depIdxs = []int32{
	5, // 0: protos.WASMRequest.step:type_name -> protos.PipelineStep
	...
	6, // 4: protos.InterStepResult.detective_result:type_name -> protos.steps.DetectiveStepResult
...
func file_sp_wsm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sp_wsm_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CustomWasm); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_sp_wsm_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
