        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* protos.NotificationSlack slack */ 1000:
                    message.config = {
                        oneofKind: "slack",
                        slack: NotificationSlack.internalBinaryRead(reader, reader.uint32(), options, message.config.slack)
                    };
                    break;
                case /* protos.NotificationEmail email */ 1001:
                    message.config = {
                        oneofKind: "email",
                        email: NotificationEmail.internalBinaryRead(reader, reader.uint32(), options, message.config.email)
                    };
                    break;
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* protos.NotificationEmailSMTP smtp */ 1000:
                    message.config = {
                        oneofKind: "smtp",
                        smtp: NotificationEmailSMTP.internalBinaryRead(reader, reader.uint32(), options, message.config.smtp)
                    };
                    break;
                case /* protos.NotificationEmailSES ses */ 1001:
                    message.config = {
                        oneofKind: "ses",
                        ses: NotificationEmailSES.internalBinaryRead(reader, reader.uint32(), options, message.config.ses)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
