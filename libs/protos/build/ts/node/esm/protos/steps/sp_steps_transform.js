 ...
 */
export var TransformTruncateType;
...
})(TransformTruncateType || (TransformTruncateType = {}));
            ...
            switch (fieldNo) {
                ...
                case /* protos.steps.TransformObfuscateOptions obfuscate_options */ 103:
                    message.options = {
                        ...
                        obfuscateOptions: TransformObfuscateOptions.internalBinaryRead(reader, reader.uint32(), options, message.options.obfuscateOptions)
                    };
                    break;
                case /* protos.steps.TransformMaskOptions mask_options */ 104:
                    message.options = {
                        oneofKind: "maskOptions",
                        maskOptions: TransformMaskOptions.internalBinaryRead(reader, reader.uint32(), options, message.options.maskOptions)
                    };
                    break;
                case /* protos.steps.TransformTruncateOptions truncate_options */ 105:
                    message.options = {
                        oneofKind: "truncateOptions",
                        truncateOptions: TransformTruncateOptions.internalBinaryRead(reader, reader.uint32(), options, message.options.truncateOptions)
                    };
                    break;
                case /* protos.steps.TransformExtractOptions extract_options */ 106:
                    message.options = {
                        oneofKind: "extractOptions",
                        extractOptions: TransformExtractOptions.internalBinaryRead(reader, reader.uint32(), options, message.options.extractOptions)
                    };
                    break;
                default:
...
// @generated message type with reflection information, may provide speed optimized methods
class TransformTruncateOptions$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class TransformMaskOptions$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class TransformExtractOptions$Type extends MessageType {
    constructor() {
