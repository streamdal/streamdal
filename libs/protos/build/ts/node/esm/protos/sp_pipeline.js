...
class PipelineStep$Type extends MessageType {
    constructor() {
        super("protos.PipelineStep", [
            ...
            { no: 4, name: "on_error", kind: "message", T: () => PipelineStepConditions },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.onError)
            PipelineStepConditions.internalBinaryWrite(message.onError, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
