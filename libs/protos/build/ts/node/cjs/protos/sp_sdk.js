...
exports.StepStatus = exports.PipelineStatus = exports.SDKRuntimeConfig = exports.SDKStartupConfig = exports.SDKResponse = exports.SDKRequest = exports.SDKClientType = exports.ExecStatus = void 0;
...
})(SDKClientType || (exports.SDKClientType = SDKClientType = {}));
// @generated message type with reflection information, may provide speed optimized methods
class SDKRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.SDKRequest = new SDKRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class SDKStartupConfig$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.SDKStartupConfig", [
            ...
            { no: 4, name: "audiences", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => sp_common_1.Audience },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.serverUrl !== "")
            writer.tag(1, runtime_1.WireType.LengthDelimited).string(message.serverUrl);
        /* string auth_token = 2; */
        if (message.authToken !== "")
            writer.tag(2, runtime_1.WireType.LengthDelimited).string(message.authToken);
        ...
        for (let i = 0; i < message.audiences.length; i++)
            sp_common_1.Audience.internalBinaryWrite(message.audiences[i], writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 pipeline_timeout_seconds = 5; */
        if (message.pipelineTimeoutSeconds !== 0)
            writer.tag(5, runtime_1.WireType.Varint).int32(message.pipelineTimeoutSeconds);
        /* int32 step_timeout_seconds = 6; */
        if (message.stepTimeoutSeconds !== 0)
            writer.tag(6, runtime_1.WireType.Varint).int32(message.stepTimeoutSeconds);
        /* bool dry_run = 7; */
        if (message.dryRun !== false)
            writer.tag(7, runtime_1.WireType.Varint).bool(message.dryRun);
        /* optional protos.SDKClientType _internal_client_type = 1000; */
        if (message.InternalClientType !== undefined)
            writer.tag(1000, runtime_1.WireType.Varint).int32(message.InternalClientType);
        /* bool _internal_shim_require_runtime_config = 2000; */
        if (message.InternalShimRequireRuntimeConfig !== false)
            writer.tag(2000, runtime_1.WireType.Varint).bool(message.InternalShimRequireRuntimeConfig);
        /* bool _internal_shim_strict_error_handling = 2001; */
        if (message.InternalShimStrictErrorHandling !== false)
            writer.tag(2001, runtime_1.WireType.Varint).bool(message.InternalShimStrictErrorHandling);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SDKRuntimeConfig$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.SDKRuntimeConfig", [
            { no: 1, name: "audience", kind: "message", T: () => sp_common_1.Audience },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.audience)
            sp_common_1.Audience.internalBinaryWrite(message.audience, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* optional bool strict_error_handling = 2; */
        if (message.strictErrorHandling !== undefined)
            writer.tag(2, runtime_1.WireType.Varint).bool(message.strictErrorHandling);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
