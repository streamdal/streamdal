...
exports.TestResponse = exports.TestRequest = exports.DeleteWasmRequest = exports.UpdateWasmRequest = exports.CreateWasmResponse = exports.CreateWasmRequest = exports.GetAllWasmResponse = exports.GetAllWasmRequest = exports.GetWasmResponse = exports.GetWasmRequest = exports.ResumeTailRequest = exports.PauseTailRequest = exports.AppRegisterRejectRequest = exports.AppVerifyRegistrationRequest = exports.AppRegistrationRequest = exports.AppRegistrationStatusResponse = exports.AppRegistrationStatusRequest = exports.GetSchemaResponse = exports.GetSchemaRequest = exports.GetAudienceRatesResponse = exports.GetAudienceRatesRequest = exports.GetMetricsResponse = exports.GetMetricsRequest = exports.DeleteServiceRequest = exports.DeleteAudienceRequest = exports.CreateAudienceRequest = exports.DetachNotificationRequest = exports.AttachNotificationRequest = exports.GetNotificationResponse = exports.GetNotificationRequest = exports.GetNotificationsResponse = exports.GetNotificationsRequest = exports.DeleteNotificationRequest = exports.UpdateNotificationRequest = exports.CreateNotificationResponse = exports.CreateNotificationRequest = exports.ResumePipelineRequest = exports.PausePipelineRequest = exports.SetPipelinesRequest = exports.DeletePipelineRequest = exports.UpdatePipelineRequest = exports.CreatePipelineResponse = exports.CreatePipelineRequest = exports.GetPipelineResponse = exports.GetPipelineRequest = exports.GetPipelinesResponse = exports.GetPipelinesRequest = exports.GetAllResponse = exports.GetAllRequest = exports.AppRegistrationStatusResponse_Status = void 0;
exports.External = exports.GetConfigResponse = exports.GetConfigRequest = void 0;
...
const sp_common_8 = require("./sp_common");
...
class GetAllResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetAllResponse", [
            ...
            { no: 2, name: "audiences", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => sp_common_8.Audience },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated protos.Audience audiences */ 2:
                    message.audiences.push(sp_common_8.Audience.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.audiences.length; i++)
            sp_common_8.Audience.internalBinaryWrite(message.audiences[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
class DeletePipelineRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.DeletePipelineRequest", [
            { no: 1, name: "pipeline_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 1000, name: "_audiences", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => sp_common_8.Audience }
        ]);
    }
    create(value) {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.Audiences.length; i++)
            sp_common_8.Audience.internalBinaryWrite(message.Audiences[i], writer.tag(1000, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SetPipelinesRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.SetPipelinesRequest", [
            ...
            { no: 2, name: "audience", kind: "message", T: () => sp_common_8.Audience },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* protos.Audience audience */ 2:
                    message.audience = sp_common_8.Audience.internalBinaryRead(reader, reader.uint32(), options, message.audience);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.audience)
            sp_common_8.Audience.internalBinaryWrite(message.audience, writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* optional string _created_by = 100; */
        if (message.CreatedBy !== undefined)
            writer.tag(100, runtime_1.WireType.LengthDelimited).string(message.CreatedBy);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class CreateNotificationResponse$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.CreateNotificationResponse = new CreateNotificationResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class CreateAudienceRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.CreateAudienceRequest", [
            { no: 1, name: "audience", kind: "message", T: () => sp_common_8.Audience }
        ]);
    }
    create(value) {
        const message = {};
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.audience)
            sp_common_8.Audience.internalBinaryWrite(message.audience, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.CreateAudienceRequest = new CreateAudienceRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class GetMetricsResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetMetricsResponse", [
            { no: 1, name: "metrics", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "message", T: () => sp_common_7.Metric } },
            { no: 1000, name: "_keepalive", kind: "scalar", opt: true, T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case 1:
                    ...
                    break;
                case 2:
                    val = sp_common_7.Metric.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for field protos.GetMetricsResponse.metrics");
            }
        }
        map[key !== null && key !== void 0 ? key : ""] = val !== null && val !== void 0 ? val : sp_common_7.Metric.create();
    }
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.metrics)) {
            writer.tag(1, runtime_1.WireType.LengthDelimited).fork().tag(1, runtime_1.WireType.LengthDelimited).string(k);
            writer.tag(2, runtime_1.WireType.LengthDelimited).fork();
            sp_common_7.Metric.internalBinaryWrite(message.metrics[k], writer, options);
            writer.join().join();
        }
        /* optional bool _keepalive = 1000; */
        if (message.Keepalive !== undefined)
...
class GetAudienceRatesResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetAudienceRatesResponse", [
            { no: 1, name: "rates", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "message", T: () => sp_common_6.AudienceRate } },
            { no: 1000, name: "_keepalive", kind: "scalar", opt: true, T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case 1:
                    ...
                    break;
                case 2:
                    val = sp_common_6.AudienceRate.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for field protos.GetAudienceRatesResponse.rates");
            }
        }
        map[key !== null && key !== void 0 ? key : ""] = val !== null && val !== void 0 ? val : sp_common_6.AudienceRate.create();
    }
    internalBinaryWrite(message, writer, options) {
        ...
        for (let k of Object.keys(message.rates)) {
            writer.tag(1, runtime_1.WireType.LengthDelimited).fork().tag(1, runtime_1.WireType.LengthDelimited).string(k);
            writer.tag(2, runtime_1.WireType.LengthDelimited).fork();
            sp_common_6.AudienceRate.internalBinaryWrite(message.rates[k], writer, options);
            writer.join().join();
        }
        /* optional bool _keepalive = 1000; */
        if (message.Keepalive !== undefined)
...
class GetSchemaResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetSchemaResponse", [
            { no: 1, name: "schema", kind: "message", T: () => sp_common_5.Schema }
        ]);
    }
    create(value) {
        const message = {};
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* protos.Schema schema */ 1:
                    message.schema = sp_common_5.Schema.internalBinaryRead(reader, reader.uint32(), options, message.schema);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.schema)
            sp_common_5.Schema.internalBinaryWrite(message.schema, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class GetWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.GetWasmRequest = new GetWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetWasmResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetWasmResponse", [
            { no: 1, name: "wasm", kind: "message", T: () => sp_shared_1.WasmModule }
        ]);
    }
    create(value) {
        const message = {};
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* protos.shared.WasmModule wasm */ 1:
                    message.wasm = sp_shared_1.WasmModule.internalBinaryRead(reader, reader.uint32(), options, message.wasm);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.wasm)
            sp_shared_1.WasmModule.internalBinaryWrite(message.wasm, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.GetWasmResponse = new GetWasmResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetAllWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.GetAllWasmRequest = new GetAllWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetAllWasmResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetAllWasmResponse", [
            { no: 1, name: "wasm", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => sp_shared_1.WasmModule }
        ]);
    }
    create(value) {
        const message = { wasm: [] };
    ...
    internalBinaryRead(reader, length, options, target) {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated protos.shared.WasmModule wasm */ 1:
                    message.wasm.push(sp_shared_1.WasmModule.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.wasm.length; i++)
            sp_shared_1.WasmModule.internalBinaryWrite(message.wasm[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.GetAllWasmResponse = new GetAllWasmResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.CreateWasmRequest = new CreateWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateWasmResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.CreateWasmResponse", [
            { no: 1, name: "message", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
 ...
 */
exports.CreateWasmResponse = new CreateWasmResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UpdateWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.UpdateWasmRequest = new UpdateWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DeleteWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.DeleteWasmRequest = new DeleteWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class GetConfigRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.GetConfigRequest = new GetConfigRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetConfigResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetConfigResponse", [
            { no: 1, name: "config", kind: "message", T: () => sp_common_4.Config }
        ]);
    }
    create(value) {
        const message = {};
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* protos.Config config */ 1:
                    message.config = sp_common_4.Config.internalBinaryRead(reader, reader.uint32(), options, message.config);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.config)
            sp_common_4.Config.internalBinaryWrite(message.config, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.GetConfigResponse = new GetConfigResponse$Type();
/**
...
exports.External = new runtime_rpc_1.ServiceType("protos.External", [
    ...
    { name: "GetConfig", options: {}, I: exports.GetConfigRequest, O: exports.GetConfigResponse },
    ...
    { name: "CreateNotification", options: {}, I: exports.CreateNotificationRequest, O: exports.CreateNotificationResponse },
    ...
    { name: "CreateAudience", options: {}, I: exports.CreateAudienceRequest, O: sp_common_3.StandardResponse },
    ...
    { name: "GetWasm", options: {}, I: exports.GetWasmRequest, O: exports.GetWasmResponse },
    { name: "GetAllWasm", options: {}, I: exports.GetAllWasmRequest, O: exports.GetAllWasmResponse },
    { name: "CreateWasm", options: {}, I: exports.CreateWasmRequest, O: exports.CreateWasmResponse },
    { name: "UpdateWasm", options: {}, I: exports.UpdateWasmRequest, O: sp_common_3.StandardResponse },
    { name: "DeleteWasm", options: {}, I: exports.DeleteWasmRequest, O: sp_common_3.StandardResponse },
