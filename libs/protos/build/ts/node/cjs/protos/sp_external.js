...
// @generated message type with reflection information, may provide speed optimized methods
class SetPipelineRequest$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.SetPipelineRequest", [
            { no: 1, name: "aud", kind: "message", T: () => sp_common_7.Audience },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* protos.Audience aud */ 1:
                    message.aud = sp_common_7.Audience.internalBinaryRead(reader, reader.uint32(), options, message.aud);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.aud)
            sp_common_7.Audience.internalBinaryWrite(message.aud, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* repeated string pipeline_ids = 2; */
        for (let i = 0; i < message.pipelineIds.length; i++)
            writer.tag(2, runtime_1.WireType.LengthDelimited).string(message.pipelineIds[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
exports.External = new runtime_rpc_1.ServiceType("protos.External", [
    ...
    { name: "SetPipelines", options: {}, I: exports.SetPipelineRequest, O: sp_common_3.StandardResponse },
