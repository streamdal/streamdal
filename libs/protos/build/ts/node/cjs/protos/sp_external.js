...
// @generated message type with reflection information, may provide speed optimized methods
class GetCustomWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.GetCustomWasmRequest = new GetCustomWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetCustomWasmResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetCustomWasmResponse", [
            { no: 1, name: "custom_wasm", kind: "message", T: () => sp_wsm_1.CustomWasm }
        ]);
    }
    create(value) {
        const message = {};
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* protos.CustomWasm custom_wasm */ 1:
                    message.customWasm = sp_wsm_1.CustomWasm.internalBinaryRead(reader, reader.uint32(), options, message.customWasm);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.customWasm)
            sp_wsm_1.CustomWasm.internalBinaryWrite(message.customWasm, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.GetCustomWasmResponse = new GetCustomWasmResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetAllCustomWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.GetAllCustomWasmRequest = new GetAllCustomWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetAllCustomWasmResponse$Type extends runtime_5.MessageType {
    constructor() {
        super("protos.GetAllCustomWasmResponse", [
            { no: 1, name: "custom_wasm", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => sp_wsm_1.CustomWasm }
        ]);
    }
    create(value) {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated protos.CustomWasm custom_wasm */ 1:
                    message.customWasm.push(sp_wsm_1.CustomWasm.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.customWasm.length; i++)
            sp_wsm_1.CustomWasm.internalBinaryWrite(message.customWasm[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.GetAllCustomWasmResponse = new GetAllCustomWasmResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateCustomWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.CreateCustomWasmRequest = new CreateCustomWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UpdateCustomWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.UpdateCustomWasmRequest = new UpdateCustomWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DeleteCustomWasmRequest$Type extends runtime_5.MessageType {
    constructor() {
 ...
 */
exports.DeleteCustomWasmRequest = new DeleteCustomWasmRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
exports.External = new runtime_rpc_1.ServiceType("protos.External", [
    ...
    { name: "GetCustomWasm", options: {}, I: exports.GetCustomWasmRequest, O: exports.GetCustomWasmResponse },
    { name: "GetAllCustomWasm", options: {}, I: exports.GetAllCustomWasmRequest, O: exports.GetAllCustomWasmResponse },
    { name: "CreateCustomWasm", options: {}, I: exports.CreateCustomWasmRequest, O: sp_common_3.StandardResponse },
    { name: "UpdateCustomWasm", options: {}, I: exports.UpdateCustomWasmRequest, O: sp_common_3.StandardResponse },
    { name: "DeleteCustomWasm", options: {}, I: exports.DeleteCustomWasmRequest, O: sp_common_3.StandardResponse },
