...
fn test_numeric() {
    ...
    let k8s_json = r#"{
  "metadata": {
    "name": "plumber-plumber-cluster-765fdfcc94-kw8qt",
    "generateName": "plumber-plumber-cluster-765fdfcc94-",
    "namespace": "default",
    ...
    "ownerReferences": [
      {
        "apiVersion": "apps/v1",
        "kind": "ReplicaSet",
        "name": "plumber-plumber-cluster-765fdfcc94",
  ...
  "spec": {
    ...
    "serviceAccountName": "plumber-plumber-cluster",
    "serviceAccount": "plumber-plumber-cluster",
    "nodeName": "minikube",
    "securityContext": {},
    ...
    "containerStatuses": [
      {
        ...
        "restartCount": 0,
        "image": "batchcorp/plumber:v2.1.3",
        "imageID": "docker-pullable://batchcorp/plumber@sha256:e4ddcc42e0871559299d0ba16a21a8107f4a20d85c8c5926a6b721c3a07f3c36",
