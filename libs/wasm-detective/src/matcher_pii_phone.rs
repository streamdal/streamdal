...
const ZONE_TWO_PREFIXES: [&str; 61] = [
...
const ZONE_THREE_AND_FOUR_PREFIXES: [&str; 47] = [
...
const ZONE_FIVE_PREFIXES: [&str; 27] = [ "+501", "+502", "+503", "+504", "+505", "+506", "+507", "+508", "+509", "+51", "+52",
"+53", "+54", "+55", "+56", "+57", "+58", "+590", "+591", "+592", "+593", "+594", "+595",
"+596", "+597", "+598", "+599"
];

const ZONE_SIX_PREFIXES: [&str; 28] = [
"+60", "+61", "+62", "+63", "+64", "+65", "+66", "+670", "+672", "+673", "+674", "+675",
"+676", "+677", "+678", "+679", "+680", "+681", "+682", "+683", "+685", "+686", "+687",
"+688", "+689", "+690", "+691", "+692"
];

const ZONE_SEVEN_PREFIXES: [&str; 1] = ["+7"];

const ZONE_EIGHT_PREFIXES: [&str; 11] = [
    "+81", "+82", "+84", "+850", "+852", "+853", "+855", "+856", "+86", "+880", "+886"
];

const ZONE_NINE_PREFIXES: [&str; 30] = [
...
pub fn phone_zone_two(num: String) -> Result<bool, CustomError> {
    if ZONE_TWO_PREFIXES.iter().any(|prefix| num.starts_with(prefix)) {
        return Ok(true)
    }
...
pub fn phone_zone_three_and_four(num: String) -> Result<bool, CustomError> {
    if ZONE_THREE_AND_FOUR_PREFIXES.iter().any(|prefix| num.starts_with(prefix)) {
        return Ok(true)
    }
...
pub fn phone_zone_five(num: String) -> Result<bool, CustomError> {
    if ZONE_FIVE_PREFIXES.iter().any(|prefix| num.starts_with(prefix)) {
        return Ok(true)
    }
...
pub fn phone_zone_six(num: String) -> Result<bool, CustomError> {
    if ZONE_SIX_PREFIXES.iter().any(|prefix| num.starts_with(prefix)) {
        return Ok(true)
    }
...
pub fn phone_zone_seven(num: String) -> Result<bool, CustomError> {
    if ZONE_SEVEN_PREFIXES.iter().any(|prefix| num.starts_with(prefix)) {
        return Ok(true)
    }
...
pub fn phone_zone_eight(num: String) -> Result<bool, CustomError> {
    if ZONE_EIGHT_PREFIXES.iter().any(|prefix| num.starts_with(prefix)) {
        return Ok(true)
    }
...
pub fn phone_zone_nine(num: String) -> Result<bool, CustomError> {
    if ZONE_NINE_PREFIXES.iter().any(|prefix| num.starts_with(prefix)) {
        return Ok(true)
    }
