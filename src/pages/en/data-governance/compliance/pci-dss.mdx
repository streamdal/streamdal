---
title: Managing PCI/DSS Data Standards with Streamdal
...
_(PCI DSS)_, initially introduced in 2004, is a <u>global</u> set of security 
...
🌌 **<span class="ykeyword">Data Flow Diagram</span>:** An integral part of the [Console UI](/en/core-components/console-ui/) is the [Data Graph](/en/core-components/console-ui#data-graph). It will show the flow of data throughout your entire system in a single view, and give you instant compliance with this requirement of PCI DSS.

<u>No maintenance on the Data Graph is required</u> because of how the Streamdal [SDK](/en/core-components/sdk/) works. The view it provides in the [Console UI](/en/core-components/console-ui/) is dynamic, and so long as new and existing services are instrumented with the [SDK](/en/core-components/sdk/), the [Data Graph](/en/core-components/console-ui#data-graph) will always give an up-to-date representation of data flow. 

🚓 **<span class="ykeyword">Enforcing Data Policies</span>:** You can physically apply your requirements to <a href="/en/resources-support/glossary/#producer" class="pkeyword">producers</a> and <a href="/en/resources-support/glossary/#consumer" class="pkeyword">consumers</a> of cardholder data by creating <a href="/en/resources-support/glossary/#rule-or-step" class="pkeyword">rules</a> in the [Console UI](/en/core-components/console-ui/). From there (or the Streamdal [CLI](/en/guides/tail#cli)), you can periodically audit real-time data with [Tail](/en/guides/tail/) to ensure data is flowing within the necessary compliance parameters.

🎭 **<span class="ykeyword">Data Minimization & PII Protection</span>:** <a href="/en/resources-support/glossary/#rule-or-step" class="pkeyword">Rules</a> can be created into a matrix of <a href="/en/resources-support/glossary/#pipeline-or-ruleset" class="pkeyword">pipelines</a> that data must validate through in order to continue flowing through your systems. 

**For example**: you could set up <a href="/en/resources-support/glossary/#rule-or-step" class="pkeyword">rules</a> to obfuscate or block cardholder data, and restrict access by `IP address` or `time` fields to ensure data minimization and more scrutiny over hours of use
