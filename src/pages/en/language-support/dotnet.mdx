---
title: .NET Client Support (Coming Soon!)
description: Streamdal .NET support
...
Support for .NET is currently not available, but we're planning to add it.
...
|---|---|
|confluent-kafka-dotnet|aspnetcore|
|rabbitmq-dotnet-client|Dapper|
|RestSharp|mongo-csharp-driver|
|Flurl|npgsql|
|MassTransit||
