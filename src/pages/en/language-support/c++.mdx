---
title: C++ Client Support (Coming Soon!)
description: Snitch C++ support
...
Support for C/C++ is currently not available, but we're planning to add it.
...
|---|---|
|librdkafka|libpqxx|
|rabbitmq-c|mongo-cxx|
|libgraphqlparser|SQLite|
|cpp-httplib|cpp_redis|
|nats.c|cpp-netlib|
...
For more information on the progress for C++ support, check out our 
