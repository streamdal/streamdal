...
metaTitle: "Plumber: Deploy In Server Mode"
description: How to deploy plumber
...
Follow the `README.md` in https://github.com/streamdal/plumber-helm#standalone
...
Follow the `README.md` in https://github.com/streamdal/plumber-helm#cluster-mode
