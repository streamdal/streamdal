...
<img src={consoleDashboard} alt="Streamdal Console Dashboard" />
...
- **Encode & Decode Rules**: Determine data encoding before transmission and decoding upon reception (Coming Soon).
- **Transformation Rules**: Set real-time data transformation parameters, catering to dynamic requirements.

<img src={consolePipeline} alt="Streamdal Console Dashboard" />
