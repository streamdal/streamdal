...
import logo from "@images/getting-started/streamdal-logo.png";
...
Requires you to specify to add the following statements at the top of the mdx file:
...
<img src={logo} alt="Streamdal logo" />
