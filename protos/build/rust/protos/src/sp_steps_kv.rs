...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12\x13\n\x0fKV_STATUS_ERROR\x10\x03B=Z;github.com/streamdal/mono/libs/\
    protos/build/go/protos/stepsJ\xfe\x1a\n\x06\x12\x04\0\0Z\x01\n\x08\n\x01\
    \x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x02\0\x15\nE\n\x02\x03\0\
    \x12\x03\x05\0\x20\x1a:\x20We\x20are\x20importing\x20this\x20to\x20get\
    \x20access\x20to\x20the\x20KVAction\x20type\n\n\x08\n\x01\x08\x12\x03\
    \x07\0R\n\t\n\x02\x08\x0b\x12\x03\x07\0R\n\xa7\n\n\x02\x05\0\x12\x04$\03\
    \x01\x1a\xfe\x01\x20Used\x20by\x20frontend\x20when\x20constructing\x20a\
    \x20pipeline\x20that\x20contains\x20a\x20KV\x20step\x20that\n\x20perform\
    s\x20any\x20KV\x20request.\x20The\x20mode\x20determines\x20_what_\x20the\
    \x20contents\x20of\x20the\n\x20key\x20will\x20be.\x20Read\x20comments\
    \x20about\x20\"static\"\x20vs\x20\"dynamic\".\n\x20protolint:disable:nex\
    t\x20ENUM_FIELD_NAMES_PREFIX\n2\x99\x08\x20!!!!!!!!!!!!!!!!!!!!!!!!!!!\
    \x20IMPORTANT\x20!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n\n\x20KV\x20consists\
    \x20of\x20two\x20parts:\n\n\x20-\x20KVStep\n\x20-\x20KVStepResponse\n\n\
    \x20KVStep\x20is\x20used\x20in\x20PipelineSteps\x20that\x20will\x20execu\
    te\x20a\x20specific\x20KV\x20request;\n\x20the\x20actual\x20KV\x20lookup\
    \x20is\x20performed\x20by\x20the\x20KV\x20WASM\x20func\x20that\x20calls\
    \x20out\x20to\n\x20HostFuncKVExists()\x20that\x20is\x20a\x20function\x20\
    exported\x20by\x20the\x20SDK.\n\n\x20The\x20HostFuncKVExists()\x20functi\
    on\x20is\x20needed\x20because\x20as\x20of\x2008.30.2023,\x20WASM\x20does\
    \n\x20not\x20have\x20socket\x20support,\x20so\x20we\x20need\x20to\x20cal\
    l\x20out\x20to\x20the\x20SDK\x20to\x20perform\x20the\n\x20actual\x20KV\
    \x20API\x20call.\n\n\x20NOTE:\x20The\x20KV\x20host\x20funcs\x20accept\
    \x20a\x20special\x20request\x20type\x20but\x20return\x20a\x20generic\n\
    \x20response.\x20This\x20is\x20done\x20so\x20that\x20we\x20can\x20includ\
    e\x20custom\x20request\x20params\x20that\n\x20might\x20only\x20be\x20rel\
    evant\x20to\x20that\x20specific\x20KV\x20func\x20while\x20the\x20respons\
